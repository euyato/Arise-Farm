if (game:GetService("CoreGui")):FindFirstChild("AriseHub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).AriseHub:Destroy();
...
ImageButton.Image = "rbxthumb://type=Asset&id=119850877212299&w=420&h=420";
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("AriseHub")).Enabled = not (game.CoreGui:FindFirstChild("AriseHub")).Enabled;
end);
...
function Update:Notify(desc)
	...
	Image.Image = "rbxthumb://type=Asset&id=119850877212299&w=420&h=420";
	Title.Parent = Frame;
...
function Update:StartLoad()
	...
	barTweenPart1.Completed:Connect(function()
		...
		barTweenPart2.Completed:Connect(function()
			wait(1);
			running = false;
			DescriptionLoader.Text = "Concluído!";
			wait(0.5);
			Loader:Destroy();
		end);
	end);
	spawn(function()
		while running do
			...
			DescriptionLoader.Text = "Aguarde um momento" .. dots;
			wait(0.5);
		end;
	end);
end;
...
function Update:Window(Config)
	...
	local AriseHub = Instance.new("ScreenGui");
	AriseHub.Name = "AriseHub";
	AriseHub.Parent = game.CoreGui;
	AriseHub.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = AriseHub;
