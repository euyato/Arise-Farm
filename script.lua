...
local MainTab = Library:Tab("Inicio", "rbxassetid://10723407389");
local FarmTab = Library:Tab("Auto Farm", "rbxassetid://10723415335");
local ItemsTab = Library:Tab("Auto Itens", "rbxassetid://10709782497");
...
RaceV4Tab = Library:Tab("Evoluir Raça", "rbxassetid://10723425539");
end;
local CombatTab = Library:Tab("Farma PVP", "rbxassetid://10734975486");
if World2 or World3 then
...
if World1 and _G.Settings.Items["Auto Second Sea"] then
...
until not boss.Parent or boss.Humanoid.Health <= 0 or not _G.Settings.Items["Auto Second Sea"]
    end
end
...
MainTab:Seperator("Farma Level");
local WeaponList = {
	"Melee",
	"Sword",
	"Fruit"
};
MainTab:Dropdown("Escolha a arma", WeaponList, _G.Settings.Main["Select Weapon"], function(value)
...
MainTab:Dropdown("Modo de Farm", ListF, _G.Settings.Main["Farm Mode"], function(value)
...
if World1 then
	MainTab:Toggle("Auto Farm Rapido", _G.Settings.Main["Auto Farm Fast"], "Farm Sky Lv.10-75", function(value)
...
MainTab:Seperator("Farma Maestria");
if World3 then
	ListMasteryMethod = {
		"Quest",
		"No Quest",
...
MainTab:Dropdown("Escolha o Modo", ListMasteryMethod, _G.Settings.Main["Selected Mastery Mode"], function(value)
	_G.Settings.Main["Selected Mastery Mode"] = value;
	(getgenv()).SaveSetting();
end);
MainTab:Toggle("Maestria de Fruta", _G.Settings.Main["Auto Farm Fruit Mastery"], "Auto Kill Mob Using Fruit", function(value)
	_G.Settings.Main["Auto Farm Fruit Mastery"] = value;
	StopTween(_G.Settings.Main["Auto Farm Fruit Mastery"]);
	(getgenv()).SaveSetting();
end);
MainTab:Toggle("Maestria de Arma", _G.Settings.Main["Auto Farm Gun Mastery"], "Auto Kill Mob Using Gun", function(value)
...
MainTab:Dropdown("Escolha Espada", SwordList, _G.Settings.Main["Selected Mastery Sword"], function(value)
...
MainTab:Toggle("Maestria de Espada", _G.Settings.Main["Auto Farm Sword Mastery"], "Auto Kill Mob Using Sword", function(value)
...
MainTab:Seperator("Farma Mobs");
MainTab:Dropdown("Escolha o Mob", tableMon, _G.Settings.Main["Selected Mob"], function(value)
...
MainTab:Seperator("Farma Bosses");
local BossLabel = MainTab:Label("Status: Escolha o Boss");
spawn(function()
	while wait(0.2) do
		pcall(function()
			if (game:GetService("ReplicatedStorage")):FindFirstChild(_G.Settings.Main["Selected Boss"]) or (game:GetService("Workspace")).Enemies:FindFirstChild(_G.Settings.Main["Selected Boss"]) then
				BossLabel:Set("Status: Spawnado!");
			else
				BossLabel:Set("Status: Boss");
			end;
		end);
	end;
end);
...
MainTab:Dropdown("Escolha o Boss", tableBoss, _G.Settings.Main["Selected Boss"], function(value)
	_G.Settings.Main["Selected Boss"] = value;
	(getgenv()).SaveSetting();
end);
MainTab:Toggle("Farma Boss", _G.Settings.Main["Auto Farm Boss"], "Auto Kill Selected Boss", function(value)
...
MainTab:Toggle("Farma Todos Boss", _G.Settings.Main["Auto Farm All Boss"], "Auto Kill All Boss", function(value)
...
if World3 then
	FarmTab:Seperator("Caçador de Elite");
		...
		while wait(0.2) do
			pcall(function()
				if (game:GetService("ReplicatedStorage")):FindFirstChild("Diablo") or (game:GetService("ReplicatedStorage")):FindFirstChild("Deandre") or (game:GetService("ReplicatedStorage")):FindFirstChild("Urban") or (game:GetService("Workspace")).Enemies:FindFirstChild("Diablo") or (game:GetService("Workspace")).Enemies:FindFirstChild("Deandre") or (game:GetService("Workspace")).Enemies:FindFirstChild("Urban") then
					...
					Elite_Hunter_Status:Set("Status: Elite Não Spawnado!");
				end;
			end);
		end;
	end);
	FarmTab:Toggle("Todos Elite", _G.Settings.Farm["Auto Elite Hunter"], "Auto Kill Elite Hunter When Spawn", function(value)
	...
	FarmTab:Button("Checar Progresso", function()
		Update:Notify("Elite Hunter Progresso: " .. (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("EliteHunter", "Progress"), 3);
	end);
	...
	FarmTab:Seperator("Farma Ossos");
	local ListB = {
		"Quest",
		"No Quest"
	};
	FarmTab:Dropdown("Escolha o Modo", ListB, _G.Settings.Farm["Selected Bone Farm Mode"], function(value)
	...
	spawn(function()
		while wait(1) do
			pcall(function()
				...
				BonesOwnedStatus:Set("Quantidade Ossos: " .. tostring(Bones));
			end);
		end;
	end);
	local BoneFarm = FarmTab:Toggle("Auto Farm Ossos", _G.Settings.Farm["Auto Farm Bone"], "Auto Kill Bone Mob", function(value)
	...
	FarmTab:Toggle("Girar Ossos", _G.Settings.Farm["Auto Random Surprise"], "Auto Trade Bone", function(value)
...
FarmTab:Seperator("Observação");
local ObservationRange = FarmTab:Label("");
spawn(function()
	while wait(0.2) do
		pcall(function()
			ObservationRange:Set("Pontos Observação: " .. math.floor((game:GetService("Players")).LocalPlayer.VisionRadius.Value));
		end);
	end;
end);
FarmTab:Toggle("Farma Observação", _G.Settings.Farm["Auto Farm Observation"], false, function(value)
			...
			while wait(0.2) do
				if _G.Settings.Farm["Auto Farm Observation"] then
					if (game:GetService("Players")).LocalPlayer.VisionRadius.Value >= 5000 then
						Update:Notify("Você Tem Pontos Maximos", 3);
						wait(2);
					elseif World2 then
...
if World1 then
	FarmTab:Toggle("Auto Farm Saber", _G.Settings.Farm["Auto Saber"], "Auto Get Saber", function(value)
...
FarmTab:Seperator("Farma Baús");
FarmTab:Toggle("Auto Farma Baús [ TW ]", _G.Settings.Farm["Auto Farm Chest Tween"], "Auto Claim Chest Tween", function(value)
...
FarmTab:Toggle("Auto Farma Baús [ TP ]", _G.Settings.Farm["Auto Farm Chest Instant"], "Auto Claim Chest Teleport", function(value)
	_G.Settings.Farm["Auto Farm Chest Instant"] = value;
	(getgenv()).SaveSetting();
end);
FarmTab:Toggle("Auto Baús Server", _G.Settings.Farm["Auto Chest Hop"], "Auto Hop if chest is not avillable", function(value)
	_G.Settings.Farm["Auto Chest Hop"] = value;
	(getgenv()).SaveSetting();
end);
FarmTab:Toggle("Auto Farma Itens", _G.Settings.Farm["Auto Stop Items"], "Stop When Get God's Chalice or FoD", function(value)
...
if World2 or World3 then
	FarmTab:Toggle("Auto Farma Baús Miragem", _G.Settings.Farm["Auto Farm Chest Mirage"], "Auto Claim Chest Mirage", function(value)
...
if World3 then
	FarmTab:Seperator("Farma Katakuri");
	local CakePrinceStatus = FarmTab:Label("Katakuri Status");
	spawn(function()
		while task.wait(5) do
			pcall(function()
				if string.len((game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88 then
					CakePrinceStatus:Set("Katakuri Npcs: " .. string.sub((game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 41) .. " Restantes");
				elseif string.len((game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 87 then
					CakePrinceStatus:Set("Katakuri Npcs: " .. string.sub((game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 40) .. " Restantes");
				elseif string.len((game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86 then
					CakePrinceStatus:Set("Katakuri Npcs: " .. string.sub((game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 39) .. " Restantes");
				else
					CakePrinceStatus:Set("Katakuri Status: Spawnado!");
				end;
			end);
		end;
	end);
	...
	FarmTab:Toggle("Auto Spawna Katakuri", _G.Settings.Farm["Auto Spawn Cake Prince"], false, function(value)
	...
	FarmTab:Toggle("Matar Katakuri v1", _G.Settings.Farm["Auto Kill Cake Prince"], false, function(value)
	...
	FarmTab:Toggle("Matar Katakuri v2", _G.Settings.Farm["Auto Kill Dough King"], false, function(value)
...
SettingsTab:Seperator("Configurações");
SettingsTab:Toggle("Posição de rota", _G.Settings.Setting["Spin Position"], "Spin Position When Farm", function(value)
	_G.Settings.Setting["Spin Position"] = value;
	(getgenv()).SaveSetting();
end);
SettingsTab:Slider("Farm Distancia", 0, 50, _G.Settings.Setting["Farm Distance"], function(value)
	_G.Settings.Setting["Farm Distance"] = value;
	(getgenv()).SaveSetting();
end);
SettingsTab:Slider("Velocidade do Player", 100, 350, _G.Settings.Setting["Player Tween Speed"], function(value)
	_G.Settings.Setting["Player Tween Speed"] = value;
	(getgenv()).SaveSetting();
end);
SettingsTab:Toggle("Puxar Mob", _G.Settings.Setting["Bring Mob"], false, function(value)
...
SettingsTab:Dropdown("Modo Puxar Mob", Bring, _G.Settings.Setting["Bring Mob Mode"], function(value)
...
SettingsTab:Toggle("Modo Ataque", _G.Settings.Setting["Fast Attack"], "Fast Attack", function(value)
...
SettingsTab:Dropdown("Ataque Rápido", AttackList, _G.Settings.Setting["Fast Attack Mode"], function(value)
	_G.Settings.Setting["Fast Attack Mode"] = value;
	(getgenv()).SaveSetting();
end);
SettingsTab:Toggle("Ataque Aura", _G.Settings.Setting["Attack Aura"], "Attack Mob", function(value)
...
SettingsTab:Seperator("Grafico");
SettingsTab:Toggle("Ocultar notificações", _G.Settings.Setting["Hide Notification"], "Invisible Notification", function(value)
...
SettingsTab:Toggle("Ocultar texto de dano", _G.Settings.Setting["Hide Damage Text"], "Invisible Damage Text", function(value)
...
SettingsTab:Toggle("Tela preta", _G.Settings.Setting["Black Screen"], false, function(value)
...
SettingsTab:Toggle("Tela branca", _G.Settings.Setting["Black Screen"], false, function(value)
...
SettingsTab:Toggle("Ocultar monstros", _G.Settings.Setting["Hide Monster"], "Invisible Monstera", function(value)
...
SettingsTab:Seperator("Configurar maestria ");
...
SettingsTab:Seperator("Outros");
SettingsTab:Toggle("Auto chegar ponto", _G.Settings.Setting["Auto Set Spawn Point"], "Set Spawn Point", function(value)
...
SettingsTab:Toggle("Auto Observação", false, "Auto Active Observation", function(value)
...
SettingsTab:Toggle("Entrar novamente", _G.Settings.Setting["Auto Rejoin"], "Auto Rejoin if disconnected or get kicked", function(value)
...
SettingsTab:Toggle("Anti detecção", true, "Reset Flags", function(value)
...
if World1 then
	ItemsTab:Toggle("Auto segundo sea", _G.Settings.Items["Auto Second Sea"], false, function(value)
...
if World2 then
	ItemsTab:Toggle("Auto terceiro sea", _G.Settings.Items["Auto Third Sea"], false, function(value)
...
if World2 then
	ItemsTab:Toggle("Auto Farma Fabrica", _G.Settings.Items["Auto Farm Factory"], false, function(value)
...
SeaStackTab:Seperator("Ilha Pré historica");
...
SeaStackTab:Toggle("Auto Pré historica [ TW ]", _G.Settings.SeaStack["Tween To Prehistoric Island"], "Need Spawn Prehistoric Island", function(value)
	...
	SeaStackTab:Toggle("Auto Golem de larva", _G.Settings.SeaStack["Auto Kill Lava Golem"], "Need Spawn Prehistoric Island", function(value)
...
ItemsTab:Seperator("Arma e espada");
if World3 then
	...
	function GuitarPuzzleProgress()
		if not CommF:InvokeServer("GuitarPuzzleProgress", "Check") then
			if game.Lighting.Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149431" and (game.Lighting.ClockTime > 16 or game.Lighting.ClockTime < 5) then
				...
				Update:Notify("Pulo Lua Cheia", 5);
				Hop();
			end;
		else
			...
			if _G.Settings.Items["Auto Tushita"] and World3 then
				pcall(function()
					...
					elseif CheckNameBoss("rip_indra True Form [Lv. 5000] [Raid Boss]") then
						...
						Update:Notify("Rip Indra Não Spawnado", 2);
						task.wait(3);
					end;
				end);
			end;
...
if World3 then
	...
	SeaTab:Dropdown("Escolha o barco", ListSeaBoat, _G.Settings.SeaEvent["Selected Boat"], function(value)
		_G.Settings.SeaEvent["Selected Boat"] = value;
		(getgenv()).SaveSetting();
	end);
	SeaTab:Dropdown("Escolha a zona", ListSeaZone, _G.Settings.SeaEvent["Selected Zone"], function(value)
		_G.Settings.SeaEvent["Selected Zone"] = value;
		(getgenv()).SaveSetting();
	end);
	SeaTab:Slider("Velocidade barco", 100, 350, _G.Settings.SeaEvent["Boat Tween Speed"], function(value)
	...
	SeaTab:Toggle("Auto Mar", _G.Settings.SeaEvent["Sail Boat"], "Sail Boat", function(value)
...
if World2 then
	ItemsTab:Toggle("Auto Bartilo Quest", _G.Settings.Items["Auto Bartilo Quest"], false, function(value)
...
StatsTab:Seperator("Status");
local Pointstat = StatsTab:Label("Stat Points");
spawn(function()
	while wait(0.2) do
		pcall(function()
			Pointstat:Set("Status Points: " .. tostring((game:GetService("Players")).LocalPlayer.Data.Points.Value));
		end);
	end;
end);
...
if World2 then
	...
	RaceV4Tab:Toggle("Auto Evo Raça [ V3 ]", _G.Settings.Race["Auto Race V3"], "false", function(value)
...
if World3 then
	...
	RaceV4Tab:Dropdown("Escolha o local", PlaceV4List, _G.Settings.Race["Selected PlaceV4"], function(value)
	...
	RaceV4Tab:Seperator("Auto Complete Triais");
...
CombatTab:Toggle("Ativar PvP", _G.Settings.Combat["Enable PvP"], "Enable PvP", function(value)
...
CombatTab:Toggle("Zona segura", false, "Auto Teleport To Up", function(value)
	_G.Safe_Mode = value;
...
if World2 or World3 then
	...
	local Island = RaidTab:Label("Iniciar Dungeon");
	spawn(function()
		pcall(function()
			while wait(0.2) do
				if (game:GetService("Players")).LocalPlayer.PlayerGui.Main.TopHUDList.RaidTimer.Visible == true then
					...
					TimeRaid:Set("Aguardando Dungeon");
				end;
			end;
		end);
	end);
	...
	RaidTab:Toggle("Auto Raid completo", _G.Settings.Raid["Auto Dungeon"], "Start, Buy Chip, Kill Mob, Next Island", function(value)
	...
	RaidTab:Toggle("Auto Laboratório", _G.Settings.Raid["GoToLab"], "Teleportar até o laboratório", function(value)
    _G.Settings.Raid["GoToLab"] = value;
    SaveSetting();
end);

spawn(function()
while wait(1) do
if _G.Settings.Raid["GoToLab"] then
if World2 then
...
TeleportTab:Seperator("Mundo");
TeleportTab:Button("Teleport To First Sea", function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("TravelMain");
end);
TeleportTab:Button("Teleporte Segundo Sea", function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("TravelDressrosa");
end);
TeleportTab:Button("Teleporte Terceiro Sea", function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("TravelZou");
end);
TeleportTab:Seperator("Ilhas");
if World1 then
	TeleportTab:Dropdown("Escolha Ilha", {
		"WindMill",
		"Marine",
		"Middle Town",
		"Jungle",
...
if World1 then
	TeleportTab:Dropdown("Escolha o NPC", {
		"Random Devil Fruit",
		"Blox Fruits Dealer",
		"Remove Devil Fruit",
		"Ability Teacher",
...
if World2 then
	ShopTab:Seperator("Espadas lendarias");
	...
	spawn(function()
		while wait(0.2) do
			pcall(function()
				...
				if response then
					MOA_Status:Set("Mestre das Auras surge!");
				else
					MOA_Status:Set("Mestre das Auras Não Gera!");
				end;
			end);
		end;
	end);
	ShopTab:Toggle("Comprar Haki Cor", _G.Settings.Shop["Auto Buy Haki Color"], "Auto Buy Haki Color", function(value)
...
ShopTab:Dropdown("Selecionar Barco", BoatList, false, function(value)
	SelectBoat = value;
end);
ShopTab:Button("Comprar barco", function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyBoat", _G.SelectBoat);
end);
ShopTab:Seperator("Estilos de luta");
...
ShopTab:Button("Pole v2 [ Æ’5,000 ]", function()
	game.ReplicatedStorage.Remotes.CommF_:InvokeServer("ThunderGodTalk");
end);
ShopTab:Seperator("Armas");
...
ShopTab:Seperator("Status");
ShopTab:Button("Reseta Status [ Use Æ’2,500 ]", function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "Refund", "1");
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "Refund", "2");
end);
ShopTab:Button("Girar Raça [ Use Æ’3000 ]", function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "Reroll", "1");
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "Reroll", "2");
end);
ShopTab:Seperator("Accessorios");
...
FruitTab:Button("Girar Fruta", function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("Cousin", "Buy");
end);
FruitTab:Button("Abrir Loja", function()
...
FruitTab:Dropdown("Guardar Fruta Rara", SelectRarityFruits, _G.Settings.Fruit["Store Rarity Fruit"], function(value)
...
FruitTab:Toggle("Auto Guardar Fruta", _G.Settings.Fruit["Auto Store Fruit"], "Store Fruit", function(value)
...
FruitTab:Toggle("Fruta Notificador", _G.Settings.Fruit["Fruit Notification"], "Add Notification When Fruit Spawn", function(value)
...
FruitTab:Toggle("Teleporta Fruta", _G.Settings.Fruit["Teleport To Fruit"], "Teleport To Fruit Instant", function(value)
...
FruitTab:Toggle("Tween Fruta", _G.Settings.Fruit["Tween To Fruit"], "Teleport To Fruit Using Tween", function(value)
...
if World2 or World3 then
	EspTab:Toggle("Esp Miragem Island", _G.Settings.Esp["ESP Mirage"], "Highlight Mirage Island", function(value)
...
spawn(function()
	pcall(function()
		while wait(0.2) do
			if game.Workspace._WorldOrigin.Locations:FindFirstChild("Kitsune Island") then
				KitsuneStatus:Set("Ilha Kitsune está surgindo");
			else
				KitsuneStatus:Set("Ilha Kitsune não aparece");
			end;
		end;
	end);
end);
spawn(function()
	pcall(function()
		while wait(0.2) do
			if game.Workspace._WorldOrigin.Locations:FindFirstChild("Frozen Dimension") then
				FrozenStatus:Set("Frozen Dimension aparece");
			else
				FrozenStatus:Set("Frozen Dimension não aparece");
			end;
		end;
	end);
end);
spawn(function()
	pcall(function()
		while wait(0.2) do
			if World2 or World3 then
				if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
					MirageStatus:Set("Miragem aparece");
				else
					MirageStatus:Set("Miragem Não aparece");
				end;
			end;
		end;
	end);
...
spawn(function()
	while wait(0.2) do
		pcall(function()
			local response = (((game:GetService("ReplicatedStorage")):WaitForChild("Remotes")):WaitForChild("CommF_")):InvokeServer("ColorsDealer", "1");
			if response then
				HakiDealer:Set("Mestre da Geração de Auras");
			else
				HakiDealer:Set("Mestre de Auras Não Gera");
			end;
		end);
	end;
end);
ServTab:Button("Reingressar no servidor", function()
	(game:GetService("TeleportService")):Teleport(game.PlaceId, (game:GetService("Players")).LocalPlayer);
end);
ServTab:Button("Mudar server", function()
	while wait(0.2) do
