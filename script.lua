...
spawn(function()
	...
	wait(1);
	((require(game.ReplicatedStorage.Notification)).new("<Color=Purple>[ Bem vindo " .. game.Players.LocalPlayer.DisplayName .. " ]<Color=/>")):Display();
	wait(1);
	((require(game.ReplicatedStorage.Notification)).new("<Color=Yellow>[ Bom Uso ]<Color=/>")):Display();
end);
function CheckQuest()
