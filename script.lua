...
--     warn("❌ Este script só deve ser executado a partir do carregador oficial do AriseHub.")
--         return
--     end
...
--     print("❌ Falha na verificação de segurança: dados de token ou chave de usuário ausentes.")
--     scary()
--     return
-- end
-- if _G._secondaryData.userKey ~= _G.__userKey then
--     print("❌ Falha na verificação de segurança: incompatibilidade de chave do usuário.")
--     return
-- end
...
--     print("❌ Falha na verificação de segurança: incompatibilidade de assinatura de token.")
--     return
-- end
...
--     print("❌ Falha na verificação de segurança: token expirou.")
--     return
-- end
-- _G._secondaryData = nil
-- _G.__userKey = nil
print("✅ Verificação de segurança aprovada. Carregando AriseHub.")
...
-- print("--------------------------------------------------------------------------");
local Update = (loadstring(Game:HttpGet("https://raw.githubusercontent.com/euyato/arise-farm/main/source.lua")))();
...
local MainTab = Library:Tab("Início", "rbxassetid://10723407389");
local FarmTab = Library:Tab("Farm", "rbxassetid://10723415335");
local ItemsTab = Library:Tab("Itens", "rbxassetid://10709782497");
local SettingsTab = Library:Tab("Configurações", "rbxassetid://10734950309");
local LocalPlayerTab = Library:Tab("Jogador", "rbxassetid://10747373176");
local HoldTab = Library:Tab("Habilidades", "rbxassetid://10734984606");
if World3 then
	SeaTab = Library:Tab("Eventos Marítimos", "rbxassetid://10709761530");
...
if World3 then
	...
	DragonDojoTab = Library:Tab("Dojo Dragão", "rbxassetid://10734951847");
end;
...
local EspTab = Library:Tab("Rastreio", "rbxassetid://10723346959");
...
local ServTab = Library:Tab("Servidor", "rbxassetid://10723426722");
_G.Settings = {
	Main = {
		["Select Weapon"] = "Melee",
		["Farm Mode"] = "Normal",
		...
		["Farm Fruit Mastery"] = false,
		["Farm Gun Mastery"] = false,
		["Selected Mastery Sword"] = nil,
		["Farm Sword Mastery"] = false,
		["Selected Mob"] = nil,
		["Farm Mob"] = false,
		["Selected Boss"] = nil,
		["Farm Boss"] = false,
	...
	Farm = {
		...
		["Auto Saber"] = false,
		["Farm Chest Tween"] = false,
		["Farm Chest Instant"] = false,
		["Auto Chest Hop"] = false,
		["Farm Chest Mirage"] = false,
		["Auto Stop Items"] = false,
		["Auto Katakuri"] = false,
		["Auto Príncipe do Bolo"] = false,
		["Auto Príncipe do Bolo"] = false,
		["Auto Rei Dough"] = false,
		["Auto Material Radioativo"] = false,
		["Auto Gota Mística"] = false,
		["Auto Minério de Magma"] = false,
		["Auto Asas Angelicais"] = false,
		["Auto Couro"] = false,
		["Auto Metal Sucata"] = false,
		["Auto Cacau Conjurado"] = false,
		["Auto Escama de Dragão"] = false,
		["Auto Pó de Arma"] = false,
		["Auto Cauda de Peixe"] = false,
		["Auto Mini Presa"] = false
	},
	Setting = {
		["Spin Position"] = false,
		["Farm Distance"] = 25,
	...
	Items = {
		["Auto Segundo Mar"] = false,
		["Auto Terceiro Mar"] = false,
		["Farm Factory"] = false,
		...
		["Auto Guitarra da Alma"] = false,
		["Auto Rengoku"] = false,
		["Auto Foice Assombrada"] = false,
		["Auto Espada do Warden"] = false,
		["Auto Katana Dupla Amaldiçoada"] = false,
		["Auto Yama"] = false,
		["Auto Tushita"] = false,
		["Auto Canvander"] = false,
		["Auto Tridente Dragão"] = false,
		["Auto Pole"] = false,
	...
	SeaEvent = {
		...
		["Farm Shark"] = false,
		["Farm Piranha"] = false,
		["Farm Fish Crew Member"] = false,
		["Farm Ghost Ship"] = false,
		["Farm Pirate Brigade"] = true,
		["Farm Pirate Grand Brigade"] = true,
		["Farm Terrorshark"] = false,
		["Farm Seabeasts"] = false,
	...
	Shop = {
		["Auto Comprar Espada Lendária"] = true,
		["Auto Comprar Cor do Haki"] = true
	},
	LocalPlayer = {
...
(getgenv()).Load = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("AriseHub") then
			makefolder("AriseHub");
		end;
		if not isfolder("AriseHub/Blox Fruits/") then
			makefolder("AriseHub/Blox Fruits/");
		end;
		if not isfile(("AriseHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("AriseHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(_G.Settings));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("AriseHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"));
	...
	if Update:SaveSettings() then
		if readfile and writefile and isfile and isfolder then
			if not isfile(("AriseHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
				...
				writefile("AriseHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
			end;
		else
			return warn("Status : Undetected Executor");
		end;
...
if World1 and _G.Settings.Items["Auto Segundo Mar"] then
local player = game.Players.LocalPlayer
local hrp = player.Character and player.Character:FindFirstChild("HumanoidRootPart")
local Replicated = game:GetService("ReplicatedStorage")

-- Verifica se já completou a missão e pode viajar
if player:FindFirstChild("Quest") and player.Quest.Value == "Dressrosa" then
Replicated.Remotes.CommF_:InvokeServer("TravelDressrosa")
return
end

-- Fala com o detetive
local function TalkToDetective()
Replicated.Remotes.CommF_:InvokeServer("StartQuest", "IceQuest", 1)
end

-- Derrota o Ice Admiral
local function KillIceAdmiral()
...
-- Se o sistema de ataque automático estiver ativado, ele usará normalmente
if not _G.Settings.Setting["Fast Attack"] then
local args = {
[1] = boss,
[2] = {
["Part"] = boss.HumanoidRootPart,
["Hit"] = boss.HumanoidRootPart.Position,
["Weapon"] = _G.Settings.Main["Select Weapon"]
}
}
game:GetService("ReplicatedStorage").Remotes.Combat:FireServer(unpack(args))
end
end)
until not boss.Parent or boss.Humanoid.Health <= 0 or not _G.Settings.Items["Auto Segundo Mar"]
    end
end

-- Verifica se já iniciou a missão
local function HasStartedQuest()
return player.PlayerGui:FindFirstChild("Quest") and player.PlayerGui.Quest.QuestTitle.Text:find("Ice Admiral")
end

if not HasStartedQuest() then
-- Move até o NPC do Detetive
hrp.CFrame = CFrame.new(1349.6, 37.4, -1325.9) -- posição do Detetive
task.wait(2)
TalkToDetective()
else
KillIceAdmiral()
...
spawn(function()
	...
	wait(1);
	((require(game.ReplicatedStorage.Notification)).new("<Color=Purple>[ Bem vindo(a) " .. game.Players.LocalPlayer.DisplayName .. " ]<Color=/>")):Display();
	wait(1);
	((require(game.ReplicatedStorage.Notification)).new("<Color=Yellow>[ Bom Uso do AriseHub ]<Color=/>")):Display();
end);
function CheckQuest()
	...
	if World1 then
		...
		elseif MyLevel == 375 or MyLevel <= 399 then
			...
			if _G.Settings.Main["Farm"] and (CFrameQuest.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 10000 then
...
spawn(function()
	pcall(function()
		while wait() do
			if World1 then
				if _G.Settings.Farm["Auto Couro"] or _G.Settings.Farm["Auto Minério de Magma"] or _G.Settings.Farm["Auto Metal Sucata"] or _G.Settings.Farm["Auto Saber"] or _G.Settings.Items["Auto Segundo Mar"] or _G.Settings.Items["Auto Espada do Warden"] or _G.Settings.Items["Auto Greybeard"] or _G.Settings.Items["Auto Pole"] or _G.Settings.Items["Auto Shark Saw"] or _G.Settings.Farm["Auto Asas Angelicais"] then
...
spawn(function()
	pcall(function()
		while wait() do
			if World2 then
				if _G.Settings.Items["Farm Factory"] or _G.Settings.Items["Auto Swan Glasses"] or _G.Settings.Raid["Law Raid"] or _G.Settings.Race["Auto Race V2"] or _G.Settings.Items["Auto Rengoku"] or _G.Settings.Items["Auto Missão do Bartilo"] or _G.Settings.Items["Auto Terceiro Mar"] or _G.Settings.Items["Auto Tridente Dragão"] or _G.Settings.Farm["Auto Couro"] or _G.Settings.Farm["Auto Minério de Magma"] or _G.Settings.Farm["Auto Material Radioativo"] or _G.Settings.Farm["Auto Metal Sucata"] or _G.Settings.SeaStack["Auto Attack Seabeasts"] or _G.Settings.Raid["Auto Dungeon"] then
					if not (game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart:FindFirstChild("BodyClip") then
						local Noclip = Instance.new("BodyVelocity");
						Noclip.Name = "BodyClip";
						Noclip.Parent = (game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart;
...
spawn(function()
	pcall(function()
		while wait() do
			if World3 then
				if _G.Settings.Farm["Auto Pirate Raid"] or _G.Settings.Race["Auto Race V3"] or _G.Settings.Farm["Auto Príncipe do Bolo"] or _G.Settings.SeaStack["Teleport To Kitsune Island"] or _G.Settings.SeaStack["Teleport To Frozen Dimension"] or _G.Settings.SeaStack["Sail To Frozen Dimension"] or _G.Settings.SeaStack["Summon Frozen Dimension"] or _G.Settings.SeaStack["Summon Kitsune Island"] or _G.Settings.SeaStack["Teleport To Mirage Island"] or _G.Settings.Race["Auto Train"] or _G.Settings.Items["Auto Press Haki Button"] or _G.Settings.SeaEvent["Sail Boat"] or _G.Settings.Items["Auto Arena Trainer"] or _G.Settings.Race["Auto Kill Player After Trial"] or _G.Settings.Race["Tween To Highest Mirage"] or _G.Settings.Race["Auto Trial"] or _G.Settings.Race["Find Blue Gear"] or _G.Settings.Combat["Auto Kill Player Quest"] or _G.Settings.Items["Auto Katana Dupla Amaldiçoada"] or _G.Settings.Farm["Farm Bone"] or _G.Settings.Farm["Auto Rei Dough"] or _G.Settings.Items["Auto Guitarra da Alma"] or _G.Settings.Items["Auto Tushita"] or _G.Settings.Farm["Auto Elite Hunter"] or _G.AutoKillSelectedPlayer or _G.Settings.Items["Auto Rainbow Haki"] or _G.Settings.Items["Auto Dark Dagger"] or _G.Settings.Farm["Farm Ectoplasm"] or _G.Settings.Farm["Auto Observation V2"] or _G.Settings.Farm["Auto Musketeer Hat"] or _G.Settings.Items["Auto Holy Torch"] or _G.Settings.Items["Auto Foice Assombrada"] or _G.Settings.Farm["Auto Katakuri"] or _G.Settings.Farm["Auto Cacau Conjurado"] or _G.Settings.Farm["Auto Cauda de Peixe"] or _G.Settings.Farm["Auto Pó de Arma"] or _G.Settings.Farm["Auto Escama de Dragão"] or _G.Settings.Farm["Auto Metal Sucata"] or _G.Settings.Farm["Auto Mini Presa"] or _G.Settings.Items["Auto Buddy Sword"] or _G.Settings.Items["Auto Canvander"] or _G.Settings.Farm["Auto Couro"] or _G.Settings.Raid["Auto Dungeon"] then
					if not (game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart:FindFirstChild("BodyClip") then
						local Noclip = Instance.new("BodyVelocity");
						Noclip.Name = "BodyClip";
						Noclip.Parent = (game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart;
...
spawn(function()
	pcall(function()
		while wait() do
			if _G.Settings.Main["Farm"] or _G.Settings.Farm["Farm Chest Tween"] or _G.Settings.Items["Auto Electric Claw"] or _G.Settings.Main["Farm Fruit Mastery"] or _G.Settings.Main["Farm Gun Mastery"] or _G.TeleportIsland or _G.AutoKillSelectedPlayer or _G.TeleportToPlayer or _G.Settings.Farm["Farm Observation"] or _G.Settings.Fruit["Tween To Fruit"] or _G.TeleportNPC or _G.Settings.Main["Farm Mob"] or _G.Settings.Main["Farm Fast"] or _G.Settings.Main["Farm All Boss"] or _G.Settings.Main["Farm Boss"] or _G.Settings.Main["Farm Sword Mastery"] then
				if not (game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart:FindFirstChild("BodyClip") then
					local Noclip = Instance.new("BodyVelocity");
					Noclip.Name = "BodyClip";
					Noclip.Parent = (game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart;
...
function UpdateTime()
	...
	Time:Set("[ Ativo ] : Horas : " .. Hour .. " Min : " .. Minute .. " Sec : " .. Second);
end;
spawn(function()
	while task.wait() do
		pcall(function()
...
MainTab:Button("Créditos Yato - 2025", function()
	setclipboard("https://instagram.com/euyato");
	Update:Notify("Copiado!", 3);
end);
...
MainTab:Toggle("Farm", _G.Settings.Main["Farm"], "Farm Selected Mode", function(value)
	_G.Settings.Main["Farm"] = value;
	StopTween(_G.Settings.Main["Farm"]);
	(getgenv()).SaveSetting();
end);
spawn(function()
	while wait(0.2) do
		if _G.Settings.Main["Farm Mode"] == "Normal" and _G.Settings.Main["Farm"] then
			pcall(function()
				CheckQuest();
								...
								if v.Name == Mon then
									if string.find((game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
										repeat
											...
											Attack();
										until not _G.Settings.Main["Farm"] or v.Humanoid.Health <= 0 or (not v.Parent) or (game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Visible == false;
									end;
								end;
							end;
						end;
...
spawn(function()
	while wait(0.2) do
		if _G.Settings.Main["Farm Mode"] == "Nearest" and _G.Settings.Main["Farm"] then
			pcall(function()
						...
						if v.Name then
							if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - (v:FindFirstChild("HumanoidRootPart")).Position).Magnitude <= 5000 then
								repeat
									...
									PosMon = v.HumanoidRootPart.CFrame;
									MonFarm = v.Name;
								until not _G.Settings.Main["Farm"] or (not v.Parent) or v.Humanoid.Health <= 0 or (not game.Workspace.Enemies:FindFirstChild(v.Name));
							end;
						end;
					end;
				end;
...
spawn(function()
	while wait(0.2) do
		if _G.Settings.Main["Farm Mode"] == "Auto Quest" and _G.Settings.Main["Farm"] then
			pcall(function()
				CheckQuest();
				local QuestTitle = (game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text;
				if not string.find(QuestTitle, NameMon) then
...
if World1 then
	MainTab:Toggle("Farm Fast", _G.Settings.Main["Farm Fast"], "Farm Sky Lv.10-75", function(value)
		_G.Settings.Main["Farm Fast"] = value;
		StopTween(_G.Settings.Main["Farm Fast"]);
		(getgenv()).SaveSetting();
	end);
	spawn(function()
		pcall(function()
			while wait(0.2) do
				if _G.Settings.Main["Farm Fast"] and World1 then
					if game.Players.LocalPlayer.Data.Level.Value >= 10 then
						_G.Settings.Main["Farm"] = false;
						_G.Settings.Main["Farm Fast"] = true;
					end;
				end;
			end;
		end);
							...
							if v.Name == "Shanda" then
								if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									repeat
										...
										topos(v.HumanoidRootPart.CFrame * Pos);
										Attack();
									until not _G.Settings.Main["Farm Fast"] or (not v.Parent) or v.Humanoid.Health <= 0;
			...
			while wait(0.2) do
				if _G.Settings.Main["Farm Fast"] and World1 then
					if game.Players.LocalPlayer.Data.Level.Value >= 75 then
						_G.Settings.Main["Farm"] = true;
						_G.Settings.Main["Farm Fast"] = false;
					end;
				end;
			end;
		end);
...
MainTab:Toggle("Farm Fruit Mastery", _G.Settings.Main["Farm Fruit Mastery"], "Auto Kill Mob Using Fruit", function(value)
	_G.Settings.Main["Farm Fruit Mastery"] = value;
	StopTween(_G.Settings.Main["Farm Fruit Mastery"]);
	(getgenv()).SaveSetting();
end);
MainTab:Toggle("Farm Gun Mastery", _G.Settings.Main["Farm Gun Mastery"], "Auto Kill Mob Using Gun", function(value)
	_G.Settings.Main["Farm Gun Mastery"] = value;
	StopTween(_G.Settings.Main["Farm Gun Mastery"]);
	(getgenv()).SaveSetting();
end);
MainTab:Line();
local SwordList = {};
...
spawn(function()
	while wait() do
		pcall(function()
			if _G.Settings.Main["Farm Sword Mastery"] then
...
MainTab:Toggle("Farm Sword Mastery", _G.Settings.Main["Farm Sword Mastery"], "Auto Kill Mob Using Sword", function(value)
	_G.Settings.Main["Farm Sword Mastery"] = value;
	StopTween(_G.Settings.Main["Farm Sword Mastery"]);
	(getgenv()).SaveSetting();
end);
spawn(function()
	while task.wait(0.2) do
		if _G.Settings.Main["Farm Sword Mastery"] and _G.Settings.Main["Selected Mastery Mode"] == "Quest" then
			pcall(function()
				CheckQuest();
							...
							if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
								if v.Name == Mon then
									repeat
										...
										PosMon = v.HumanoidRootPart.CFrame;
										MonFarm = v.Name;
									until not _G.Settings.Main["Farm Sword Mastery"] or (not v.Parent) or v.Humanoid.Health == 0 or (game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Visible == false or (not (game:GetService("Workspace")).Enemies:FindFirstChild(v.Name)) or not _G.Settings.Main["Selected Mastery Mode"] == "Quest";
								end;
							end;
						end;
					else
		...
		elseif _G.Settings.Main["Farm Sword Mastery"] and _G.Settings.Main["Selected Mastery Mode"] == "No Quest" then
			pcall(function()
				CheckQuest();
				topos(CFrameMon);
				if game.Workspace.Enemies:FindFirstChild(Mon) then
					for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
						if v.Name == Mon and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
							repeat
								...
								PosMon = v.HumanoidRootPart.CFrame;
								MonFarm = v.Name;
							until not _G.Settings.Main["Farm Sword Mastery"] or (not v.Parent) or v.Humanoid.Health == 0 or (not (game:GetService("Workspace")).Enemies:FindFirstChild(v.Name)) or not _G.Settings.Main["Selected Mastery Mode"] == "No Quest";
						end;
					end;
				else
					UnEquipWeapon(_G.Settings.Main["Selected Mastery Sword"]);
		...
		elseif _G.Settings.Main["Farm Sword Mastery"] and _G.Settings.Main["Selected Mastery Mode"] == "Bones" then
			pcall(function()
				topos(QuestBonePos);
						...
						if v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or v.Name == "Demonic Soul" or v.Name == "Posessed Mummy" then
							if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
								repeat
									...
									PosMon = v.HumanoidRootPart.CFrame;
									MonFarm = v.Name;
								until not _G.Settings.Main["Farm Sword Mastery"] or v.Humanoid.Health <= 0 or (not v.Parent) or (not (game:GetService("Workspace")).Enemies:FindFirstChild(v.Name)) or not _G.Settings.Main["Selected Mastery Mode"] == "Bones";
							end;
		...
		elseif _G.Settings.Main["Farm Sword Mastery"] and _G.Settings.Main["Selected Mastery Mode"] == "Cakeprince" then
			pcall(function()
						...
						if v.Name == "Cookie Crafter" or v.Name == "Cake Guard" or v.Name == "Baking Staff" or v.Name == "Head Baker" then
							if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
								repeat
									...
									PosMon = v.HumanoidRootPart.CFrame;
									MonFarm = v.Name;
								until not _G.Settings.Main["Farm Sword Mastery"] or v.Humanoid.Health <= 0 or (not v.Parent) or (not (game:GetService("Workspace")).Enemies:FindFirstChild(v.Name)) or not _G.Settings.Main["Selected Mastery Mode"] == "Cakeprince";
							end;
		...
		elseif _G.Settings.Main["Farm Sword Mastery"] and _G.Settings.Main["Selected Mastery Mode"] == "Nearest" then
			pcall(function()
				for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
					if v.Name and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
						if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - (v:FindFirstChild("HumanoidRootPart")).Position).Magnitude <= 2000 then
							repeat
								...
								PosMon = v.HumanoidRootPart.CFrame;
								MonFarm = v.Name;
							until not _G.Settings.Main["Farm Sword Mastery"] or (not v.Parent) or v.Humanoid.Health == 0 or not _G.Settings.Main["Selected Mastery Mode"] == "Nearest";
						end;
					end;
				end;
			end);
		elseif _G.Settings.Main["Farm Sword Mastery"] and _G.Settings.Main["Selected Mastery Mode"] == "Boss" then
			if (game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Visible == false then
				CheckBossQuest();
				topos(CFrameQBoss);
						...
						for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
							if v.Name == selectBoss and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
								repeat
									...
									PosMon = v.HumanoidRootPart.CFrame;
									MonFarm = v.Name;
								until not _G.Settings.Main["Farm Sword Mastery"] or not _G.Settings.Main["Selected Mastery Mode"] == "Boss" or (not v.Parent) or v.Humanoid.Health == 0 or game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false or (not (game:GetService("Workspace")).Enemies:FindFirstChild(v.Name));
							end;
						end;
					end;
				end);
...
spawn(function()
	while task.wait(0.2) do
		if _G.Settings.Main["Farm Fruit Mastery"] and _G.Settings.Main["Selected Mastery Mode"] == "Quest" then
			pcall(function()
				CheckQuest();
				if not string.find((game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) or (game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Visible == false then
					(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("AbandonQuest");
							...
							if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
								if v.Name == Mon then
									repeat
										...
										Skillaimbot = true;
									until not _G.Settings.Main["Farm Fruit Mastery"] or (not v.Parent) or v.Humanoid.Health == 0 or (game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Visible == false or (not (game:GetService("Workspace")).Enemies:FindFirstChild(v.Name)) or not _G.Settings.Main["Selected Mastery Mode"] == "Quest";
									UseSkill = false;
									Skillaimbot = false;
								end;
							end;
		...
		elseif _G.Settings.Main["Farm Fruit Mastery"] and _G.Settings.Main["Selected Mastery Mode"] == "No Quest" then
			pcall(function()
				CheckQuest();
				topos(CFrameMon);
				if game.Workspace.Enemies:FindFirstChild(Mon) then
					for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
						if v.Name == Mon and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
							repeat
								...
								MonFarm = v.Name;
								AimBotSkillPosition = v.HumanoidRootPart.Position;
							until not _G.Settings.Main["Farm Fruit Mastery"] or (not v.Parent) or v.Humanoid.Health == 0 or (not (game:GetService("Workspace")).Enemies:FindFirstChild(v.Name)) or not _G.Settings.Main["Selected Mastery Mode"] == "No Quest";
							UseSkill = false;
							Skillaimbot = false;
						end;
					end;
		...
		elseif _G.Settings.Main["Farm Fruit Mastery"] and _G.Settings.Main["Selected Mastery Mode"] == "Bones" then
			pcall(function()
				topos(QuestBonePos);
				if (game:GetService("Workspace")).Enemies:FindFirstChild("Reborn Skeleton") or (game:GetService("Workspace")).Enemies:FindFirstChild("Living Zombie") or (game:GetService("Workspace")).Enemies:FindFirstChild("Demonic Soul") or (game:GetService("Workspace")).Enemies:FindFirstChild("Posessed Mummy") then
					for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
						if v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or v.Name == "Demonic Soul" or v.Name == "Posessed Mummy" then
							if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
								repeat
									...
									MonFarm = v.Name;
									AimBotSkillPosition = v.HumanoidRootPart.Position;
								until not _G.Settings.Main["Farm Fruit Mastery"] or v.Humanoid.Health <= 0 or (not v.Parent) or (not (game:GetService("Workspace")).Enemies:FindFirstChild(v.Name)) or not _G.Settings.Main["Selected Mastery Mode"] == "Bones";
								UseSkill = false;
								Skillaimbot = false;
							end;
						elseif (game:GetService("ReplicatedStorage")):FindFirstChild("Demonic Soul") then
		...
		elseif _G.Settings.Main["Farm Fruit Mastery"] and _G.Settings.Main["Selected Mastery Mode"] == "Cakeprince" then
			pcall(function()
				local PosCake = CFrame.new(-2091.911865234375, 70.00884246826172, -12142.8359375);
				topos(PosCake);
				if (game:GetService("Workspace")).Enemies:FindFirstChild("Cookie Crafter") or (game:GetService("Workspace")).Enemies:FindFirstChild("Cake Guard") or (game:GetService("Workspace")).Enemies:FindFirstChild("Baking Staff") or (game:GetService("Workspace")).Enemies:FindFirstChild("Head Baker") then
						...
						if v.Name == "Cookie Crafter" or v.Name == "Cake Guard" or v.Name == "Baking Staff" or v.Name == "Head Baker" then
							if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
								repeat
									...
									MonFarm = v.Name;
									AimBotSkillPosition = v.HumanoidRootPart.Position;
								until not _G.Settings.Main["Farm Fruit Mastery"] or v.Humanoid.Health <= 0 or (not v.Parent) or (not (game:GetService("Workspace")).Enemies:FindFirstChild(v.Name)) or not _G.Settings.Main["Selected Mastery Mode"] == "Cakeprince";
								UseSkill = false;
								Skillaimbot = false;
							end;
						elseif (game:GetService("ReplicatedStorage")):FindFirstChild("Baking Staff") then
		...
		elseif _G.Settings.Main["Farm Fruit Mastery"] and _G.Settings.Main["Selected Mastery Mode"] == "Nearest" then
			pcall(function()
				for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
					if v.Name and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
						if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - (v:FindFirstChild("HumanoidRootPart")).Position).Magnitude <= 2000 then
							repeat
								...
								MonFarm = v.Name;
								AimBotSkillPosition = v.HumanoidRootPart.Position;
							until not _G.Settings.Main["Farm Fruit Mastery"] or (not v.Parent) or v.Humanoid.Health == 0 or not _G.Settings.Main["Selected Mastery Mode"] == "Nearest";
							UseSkill = false;
							Skillaimbot = false;
						end;
					end;
		...
		elseif _G.Settings.Main["Farm Fruit Mastery"] and _G.Settings.Main["Selected Mastery Mode"] == "Boss" then
			if (game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Visible == false then
				CheckBossQuest();
				topos(CFrameQBoss);
				if (CFrameQBoss.Position - (game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 5 then
						...
						for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
							if v.Name == selectBoss and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
								repeat
									...
									MonFarm = v.Name;
									AimBotSkillPosition = v.HumanoidRootPart.Position;
								until not _G.Settings.Main["Farm Fruit Mastery"] or not _G.Settings.Main["Selected Mastery Mode"] == "Boss" or (not v.Parent) or v.Humanoid.Health == 0 or game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false or (not (game:GetService("Workspace")).Enemies:FindFirstChild(v.Name));
								UseSkill = false;
								Skillaimbot = false;
							end;
						end;
...
spawn(function()
	while task.wait(0.2) do
		if _G.Settings.Main["Farm Gun Mastery"] and _G.Settings.Main["Selected Mastery Mode"] == "Quest" then
			pcall(function()
				CheckQuest();
				if not string.find((game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) or (game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Visible == false then
					(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("AbandonQuest");
							...
							if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
								if v.Name == Mon then
									repeat
										...
										MonFarm = v.Name;
										AimBotSkillPosition = v.HumanoidRootPart.Position;
									until not _G.Settings.Main["Farm Gun Mastery"] or (not v.Parent) or v.Humanoid.Health <= 0 or (game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Visible == false or (not (game:GetService("Workspace")).Enemies:FindFirstChild(v.Name)) or not _G.Settings.Main["Selected Mastery Mode"] == "Quest";
									UseGunSkill = false;
									Skillaimbot = false;
								end;
							end;
		...
		elseif _G.Settings.Main["Farm Gun Mastery"] and _G.Settings.Main["Selected Mastery Mode"] == "No Quest" then
			pcall(function()
				CheckQuest();
				topos(CFrameMon);
				if game.Workspace.Enemies:FindFirstChild(Mon) then
					for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
						if v.Name == Mon and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
							repeat
								...
								NormalAttack();
								AimBotSkillPosition = v.HumanoidRootPart.Position;
							until not _G.Settings.Main["Farm Gun Mastery"] or (not v.Parent) or v.Humanoid.Health <= 0 or (not (game:GetService("Workspace")).Enemies:FindFirstChild(v.Name)) or not _G.Settings.Main["Selected Mastery Mode"] == "No Quest";
						end;
					end;
				else
					UseGunSkill = false;
		...
		elseif _G.Settings.Main["Farm Gun Mastery"] and _G.Settings.Main["Selected Mastery Mode"] == "Bones" then
			pcall(function()
				topos(QuestBonePos);
				if (game:GetService("Workspace")).Enemies:FindFirstChild("Reborn Skeleton") or (game:GetService("Workspace")).Enemies:FindFirstChild("Living Zombie") or (game:GetService("Workspace")).Enemies:FindFirstChild("Demonic Soul") or (game:GetService("Workspace")).Enemies:FindFirstChild("Posessed Mummy") then
					for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
						if v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or v.Name == "Demonic Soul" or v.Name == "Posessed Mummy" then
							if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
								repeat
									...
									MonFarm = v.Name;
									AimBotSkillPosition = v.HumanoidRootPart.Position;
								until not _G.Settings.Main["Farm Gun Mastery"] or not _G.Settings.Main["Selected Mastery Mode"] == "Bones" or v.Humanoid.Health <= 0 or (not v.Parent);
								UseGunSkill = false;
								Skillaimbot = false;
							elseif (game:GetService("ReplicatedStorage")):FindFirstChild("Demonic Soul") then
								topos(v.HumanoidRootPart.CFrame * Pos);
		...
		elseif _G.Settings.Main["Farm Gun Mastery"] and _G.Settings.Main["Selected Mastery Mode"] == "Cakeprince" then
			pcall(function()
				local PosCake = CFrame.new(-2091.911865234375, 70.00884246826172, -12142.8359375);
				topos(PosCake);
				if (game:GetService("Workspace")).Enemies:FindFirstChild("Cookie Crafter") or (game:GetService("Workspace")).Enemies:FindFirstChild("Cake Guard") or (game:GetService("Workspace")).Enemies:FindFirstChild("Baking Staff") or (game:GetService("Workspace")).Enemies:FindFirstChild("Head Baker") then
						...
						if v.Name == "Cookie Crafter" or v.Name == "Cake Guard" or v.Name == "Baking Staff" or v.Name == "Head Baker" then
							if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
								repeat
									...
									MonFarm = v.Name;
									AimBotSkillPosition = v.HumanoidRootPart.Position;
								until not _G.Settings.Main["Farm Gun Mastery"] or not _G.Settings.Main["Selected Mastery Mode"] == "Cakeprince" or v.Humanoid.Health <= 0 or (not v.Parent);
								UseGunSkill = false;
								Skillaimbot = false;
		...
		elseif _G.Settings.Main["Farm Gun Mastery"] and _G.Settings.Main["Selected Mastery Mode"] == "Nearest" then
			pcall(function()
				for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
					if v.Name and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
						if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - (v:FindFirstChild("HumanoidRootPart")).Position).Magnitude <= 2000 then
							repeat
								...
								NormalAttack();
								AimBotSkillPosition = v.HumanoidRootPart.Position;
							until not _G.Settings.Main["Farm Gun Mastery"] or (not v.Parent) or v.Humanoid.Health <= 0 or not _G.Settings.Main["Selected Mastery Mode"] == "Nearest";
							UseGunSkill = false;
							Skillaimbot = false;
						end;
					end;
		...
		elseif _G.Settings.Main["Farm Gun Mastery"] and _G.Settings.Main["Selected Mastery Mode"] == "Boss" then
			if (game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Visible == false then
				CheckBossQuest();
				topos(CFrameQBoss);
				if (CFrameQBoss.Position - (game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 5 then
						...
						for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
							if v.Name == selectBoss and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
								repeat
									...
									NormalAttack();
									AimBotSkillPosition = v.HumanoidRootPart.Position;
								until not _G.Settings.Main["Farm Gun Mastery"] or not _G.Settings.Main["Selected Mastery Mode"] == "Boss" or (not v.Parent) or v.Humanoid.Health <= 0 or game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false or (not (game:GetService("Workspace")).Enemies:FindFirstChild(v.Name));
								Skillaimbot = false;
							end;
						end;
					else
...
MainTab:Toggle("Farm Mob", _G.Settings.Main["Farm Mob"], "Auto Kill Mob", function(value)
	_G.Settings.Main["Farm Mob"] = value;
	StopTween(_G.Settings.Main["Farm Mob"]);
	(getgenv()).SaveSetting();
end);
spawn(function()
	while wait(0.2) do
		if _G.Settings.Main["Farm Mob"] then
			pcall(function()
...
MainTab:Toggle("Farm Boss", _G.Settings.Main["Farm Boss"], "Auto Kill Selected Boss", function(value)
	_G.Settings.Main["Farm Boss"] = value;
	StopTween(_G.Settings.Main["Farm Boss"]);
	(getgenv()).SaveSetting();
end);
spawn(function()
	while wait(0.2) do
		if _G.Settings.Main["Farm Boss"] then
			pcall(function()
						...
						if v.Name == _G.Settings.Main["Selected Boss"] then
							if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
								repeat
									...
									topos(v.HumanoidRootPart.CFrame * Pos);
									Attack();
								until not _G.Settings.Main["Farm Boss"] or (not v.Parent) or v.Humanoid.Health <= 0;
							end;
						end;
					end;
...
MainTab:Toggle("Farm All Boss", _G.Settings.Main["Farm All Boss"], "Auto Kill All Boss", function(value)
	_G.Settings.Main["Farm All Boss"] = value;
	StopTween(_G.Settings.Main["Farm All Boss"]);
	(getgenv()).SaveSetting();
end);
spawn(function()
	while wait(0.2) do
		if _G.Settings.Main["Farm All Boss"] then
			pcall(function()
							...
							if v.Name == boss then
								if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									repeat
										...
										topos(v.HumanoidRootPart.CFrame * Pos);
										Attack();
									until not _G.Settings.Main["Farm All Boss"] or (not v.Parent) or v.Humanoid.Health <= 0;
								end;
							end;
						end;
...
if World3 then
	...
	local BoneFarm = FarmTab:Toggle("Farm Bone", _G.Settings.Farm["Farm Bone"], "Auto Kill Bone Mob", function(value)
		_G.Settings.Farm["Farm Bone"] = value;
		StopTween(_G.Settings.Farm["Farm Bone"]);
		(getgenv()).SaveSetting();
	end);
	local BonePos = CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Selected Bone Farm Mode"] == "No Quest" and _G.Settings.Farm["Farm Bone"] and World3 then
				pcall(function()
					if (game:GetService("Workspace")).Enemies:FindFirstChild("Reborn Skeleton") or (game:GetService("Workspace")).Enemies:FindFirstChild("Living Zombie") or (game:GetService("Workspace")).Enemies:FindFirstChild("Demonic Soul") or (game:GetService("Workspace")).Enemies:FindFirstChild("Posessed Mummy") then
						for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
							if v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or v.Name == "Demonic Soul" or v.Name == "Posessed Mummy" then
								if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									repeat
										...
										topos(v.HumanoidRootPart.CFrame * Pos);
										Attack();
									until not _G.Settings.Farm["Farm Bone"] or (not v.Parent) or v.Humanoid.Health <= 0;
								end;
							end;
						end;
					else
	...
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Selected Bone Farm Mode"] == "Quest" and _G.Settings.Farm["Farm Bone"] and World3 then
				pcall(function()
					local QuestTitle = (game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text;
									...
									if v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or v.Name == "Demonic Soul" or v.Name == "Posessed Mummy" then
										if string.find((game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Demonic Soul") then
											repeat
												...
												v.Head.CanCollide = false;
												Attack();
											until not _G.Settings.Farm["Farm Bone"] or v.Humanoid.Health <= 0 or (not v.Parent) or (game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Visible == false;
										end;
									end;
								end;
							end;
...
FarmTab:Toggle("Farm Observation", _G.Settings.Farm["Farm Observation"], false, function(value)
	_G.Settings.Farm["Farm Observation"] = value;
	StopTween(_G.Settings.Farm["Farm Observation"]);
	(getgenv()).SaveSetting();
end);
if World3 then
	...
	spawn(function()
		while wait(0.2) do
			pcall(function()
				if _G.Settings.Farm["Farm Observation"] then
					repeat
						task.wait();
					...
					until (game:GetService("Players")).LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") or (not _G.Settings.Farm["Farm Observation"]);
				end;
			end);
		end;
	end);
					...
					elseif World2 then
						if (game:GetService("Workspace")).Enemies:FindFirstChild("Lava Pirate [Lv. 1200]") then
							if (game:GetService("Players")).LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
								...
								until _G.Settings.Farm["Farm Observation"] == false or (not (game:GetService("Players")).LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel"));
							else
								repeat
									task.wait();
									(game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.CFrame = ((game:GetService("Workspace")).Enemies:FindFirstChild("Lava Pirate")).HumanoidRootPart.CFrame * CFrame.new(0, 50, 0);
									if not (game:GetService("Players")).LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") and _G.Settings.Farm["Farm Observation"] == true then
										(game:GetService("TeleportService")):Teleport(game.PlaceId, (game:GetService("Players")).LocalPlayer);
									end;
								until _G.Settings.Farm["Farm Observation"] == false or (game:GetService("Players")).LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel");
							end;
						else
...
FarmTab:Toggle("Farm Chest [ Tween ]", _G.Settings.Farm["Farm Chest Tween"], "Auto Claim Chest Tween", function(value)
	_G.Settings.Farm["Farm Chest Tween"] = value;
	StopTween(_G.Settings.Farm["Farm Chest Tween"]);
	(getgenv()).SaveSetting();
end);
spawn(function()
	while wait(0.2) do
		pcall(function()
			if _G.Settings.Farm["Farm Chest Tween"] then
				for i, v in pairs((game:GetService("Workspace")).ChestModels:GetChildren()) do
					if v.Name:find("Chest") then
						repeat
							wait();
							topos(v.RootPart.CFrame);
						until _G.Settings.Farm["Farm Chest Tween"] == false or (not v.Parent);
						topos((game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.CFrame);
					end;
				end;
			end;
...
FarmTab:Toggle("Farm Chest [ Instant ]", _G.Settings.Farm["Farm Chest Instant"], "Auto Claim Chest Teleport", function(value)
	_G.Settings.Farm["Farm Chest Instant"] = value;
	(getgenv()).SaveSetting();
end);
		...
		pcall(function()
			if _G.Settings.Farm["Auto Stop Items"] then
				if (game:GetService("Players")).LocalPlayer.Backpack:FindFirstChild("God's Chalice") or (game:GetService("Players")).LocalPlayer.Character:FindFirstChild("God's Chalice") or (game:GetService("Players")).LocalPlayer.Backpack:FindFirstChild("Fist of Darkness") or (game:GetService("Players")).LocalPlayer.Character:FindFirstChild("Fist of Darkness") then
					_G.Settings.Farm["Farm Chest Instant"] = false;
					_G.Settings.Farm["Farm Chest Tween"] = false;
					topos((game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.CFrame);
				end;
			end;
		end);
...
if World2 or World3 then
	FarmTab:Toggle("Farm Chest Mirage island", _G.Settings.Farm["Farm Chest Mirage"], "Auto Claim Chest Mirage", function(value)
		_G.Settings.Farm["Farm Chest Mirage"] = value;
		StopTween(_G.Settings.Farm["Farm Chest Mirage"]);
		(getgenv()).SaveSetting();
	end);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Farm Chest Mirage"] then
				for i, v in pairs((game:GetService("Workspace")).Map.MysticIsland.Chests:GetChildren()) do
					if string.find(v.Name, "Chest") then
						if (game:GetService("Workspace")):FindFirstChild(v.Name) then
							...
							until _G.Settings.Farm["Farm Chest Mirage"] == false or (not v.Parent);
							topos((game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.CFrame);
							break;
						end;
					end;
...
spawn(function()
	while wait(0.2) do
		pcall(function()
			if _G.Settings.Farm["Farm Chest Instant"] then
				for i, v in pairs((game:GetService("Workspace")).ChestModels:GetChildren()) do
					if v.Name:find("Chest") then
						repeat
							wait();
						...
						until not _G.Settings.Farm["Farm Chest Instant"] or (not v.Parent);
					end;
				end;
			end;
		end);
...
if World3 then
	...
	FarmTab:Toggle("Auto Katakuri", _G.Settings.Farm["Auto Katakuri"], "Farm + Kill Cake Prince", function(value)
		_G.Settings.Farm["Auto Katakuri"] = value;
		StopTween(_G.Settings.Farm["Auto Katakuri"]);
		(getgenv()).SaveSetting();
	end);
	local CakePos = CFrame.new(-2091.911865234375, 70.00884246826172, -12142.8359375);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Katakuri"] then
				pcall(function()
								...
								if v.Name == "Cake Prince" then
									if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
										repeat
											...
											RemoveAnimation(v);
											Attack();
										until not _G.Settings.Farm["Auto Katakuri"] or (not v.Parent) or v.Humanoid.Health <= 0;
									end;
								end;
							end;
							...
							if v.Name == "Cookie Crafter" or v.Name == "Cake Guard" or v.Name == "Baking Staff" or v.Name == "Head Baker" then
								if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									repeat
										...
										topos(v.HumanoidRootPart.CFrame * Pos);
										Attack();
									until not _G.Settings.Farm["Auto Katakuri"] or (not v.Parent) or v.Humanoid.Health <= 0 or (game:GetService("Workspace")).Map.CakeLoaf.BigMirror.Other.Transparency == 0 or (game:GetService("ReplicatedStorage")):FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") or (game:GetService("Workspace")).Enemies:FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]");
								end;
							end;
						end;
					else
	...
	FarmTab:Toggle("Auto Príncipe do Bolo", _G.Settings.Farm["Auto Príncipe do Bolo"], false, function(value)
		_G.Settings.Farm["Auto Príncipe do Bolo"] = value;
		(getgenv()).SaveSetting();
	end);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Príncipe do Bolo"] then
				wait(2);
				(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("CakePrinceSpawner", true);
			end;
		end;
	end);
	FarmTab:Toggle("Auto Príncipe do Bolo Only", _G.Settings.Farm["Auto Príncipe do Bolo"], false, function(value)
		_G.Settings.Farm["Auto Príncipe do Bolo"] = value;
		StopTween(_G.Settings.Farm["Auto Príncipe do Bolo"]);
		(getgenv()).SaveSetting();
	end);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Príncipe do Bolo"] and World3 then
				pcall(function()
					if (game:GetService("Workspace")).Enemies:FindFirstChild("Cake Prince") then
						for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
							if v.Name == "Cake Prince" then
								if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									...
									until not _G.Settings.Farm["Auto Príncipe do Bolo"] or (not v.Parent) or v.Humanoid.Health <= 0;
								end;
							end;
						end;
					else
	...
	FarmTab:Toggle("Auto Rei Dough Only", _G.Settings.Farm["Auto Rei Dough"], false, function(value)
		_G.Settings.Farm["Auto Rei Dough"] = value;
		StopTween(_G.Settings.Farm["Auto Rei Dough"]);
		(getgenv()).SaveSetting();
	end);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Rei Dough"] and World3 then
				pcall(function()
						...
						for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
							if v.Name == "Dough King" then
								if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									...
									until not _G.Settings.Farm["Auto Rei Dough"] or (not v.Parent) or v.Humanoid.Health <= 0;
								end;
							end;
						end;
					end;
...
spawn(function()
	(game:GetService("RunService")).RenderStepped:Connect(function()
		if _G.Settings.Setting["Attack Aura"] and (not _G.Settings.Main["Farm Fruit Mastery"]) and (not _G.Settings.Main["Farm Gun Mastery"]) then
			pcall(function()
				Attack();
			end);
		end;
...
function Attack()
	if not _G.Settings.Main["Farm Fruit Mastery"] or (not _G.Settings.Main["Farm Gun Mastery"]) then
...
if World1 then
	ItemsTab:Toggle("Auto Segundo Mar", _G.Settings.Items["Auto Segundo Mar"], false, function(value)
		_G.Settings.Items["Auto Segundo Mar"] = value;
		StopTween(_G.Settings.Items["Auto Segundo Mar"]);
		(getgenv()).SaveSetting();
	end);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Items["Auto Segundo Mar"] then
				pcall(function()
					...
					if MyLevel >= 700 and World1 then
						if (game:GetService("Workspace")).Map.Ice.Door.CanCollide == false and (game:GetService("Workspace")).Map.Ice.Door.Transparency == 1 then
							...
							repeat
								topos(CFrame1);
								wait();
							until (CFrame1.Position - (game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 or _G.Settings.Items["Auto Segundo Mar"] == false;
							wait(1.1);
							...
							repeat
								...
								wait();
							until (Vector3.new(1347.7124, 37.3751602, (-1325.6488)) - (game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 or _G.Settings.Items["Auto Segundo Mar"] == false;
							wait(0.5);
										...
										if not v.Humanoid.Health <= 0 then
											if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
												...
												repeat
													...
													topos(v.HumanoidRootPart.CFrame * Pos);
													Attack();
												until not _G.Settings.Items["Auto Segundo Mar"] or (not v.Parent) or v.Humanoid.Health <= 0;
											end;
										else
...
if World2 then
	ItemsTab:Toggle("Auto Terceiro Mar", _G.Settings.Items["Auto Terceiro Mar"], false, function(value)
		_G.Settings.Items["Auto Terceiro Mar"] = value;
		StopTween(_G.Settings.Items["Auto Terceiro Mar"]);
		(getgenv()).SaveSetting();
	end);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Items["Auto Terceiro Mar"] then
				pcall(function()
							...
							if (game:GetService("Workspace")).Enemies:FindFirstChild("rip_indra") then
								for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
									if v.Name == "rip_indra" then
										...
										until _G.Settings.Items["Auto Terceiro Mar"] == false or v.Humanoid.Health <= 0 or (not v.Parent);
									end;
								end;
...
if World2 then
	ItemsTab:Toggle("Farm Factory", _G.Settings.Items["Farm Factory"], false, function(value)
		_G.Settings.Items["Farm Factory"] = value;
		StopTween(_G.Settings.Items["Farm Factory"]);
		(getgenv()).SaveSetting();
	end);
	spawn(function()
		while wait(0.2) do
			pcall(function()
				if _G.Settings.Items["Farm Factory"] then
						...
						for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
							if v.Name == "Core" and v.Humanoid.Health > 0 then
								repeat
									...
									AttackOld();
								until v.Humanoid.Health <= 0 or _G.Settings.Items["Farm Factory"] == false;
							end;
						end;
					else
						topos(CFrame.new(448.46756, 199.356781, -441.389252));
		...
		pcall(function()
			while wait(0.2) do
				if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
					Mirragecheck:Set("Miragem Spawning");
					_G.MirageSpawn = true;
				else
					Mirragecheck:Set("Miragem Not Spawn");
						...
						if (game:GetService("Workspace")):FindFirstChild("SeaBeasts") then
							for i, v in pairs((game:GetService("Workspace")).SeaBeasts:GetChildren()) do
								if CheckSeaBeast() then
									...
									until not _G.Settings.SeaEvent["Farm Seabeasts"] or CheckSeaBeast() == false or (not v:FindFirstChild("Humanoid")) or (not v:FindFirstChild("HumanoidRootPart")) or v.Humanoid.Health < 0 or (not v.Parent);
									Skillaimbot = false;
									_G.SeaSkill = false;
								else
									Skillaimbot = false;
...
if World3 then
	DragonDojoTab:Seperator("Dojo Dragão");
	...
	spawn(function()
		while wait(0.2) do
			if _G.Settings.DragonDojo["Farm Blaze Ember"] then
				pcall(function()
	...
	DragonDojoTab:Toggle("Farm Blaze Ember", _G.Settings.DragonDojo["Farm Blaze Ember"], "Farm Blaze Ember", function(value)
		_G.Settings.DragonDojo["Farm Blaze Ember"] = value;
		StopTween(_G.Settings.DragonDojo["Farm Blaze Ember"]);
		(getgenv()).SaveSetting();
	end);
				...
				if v.Name == "Venomous Assailant" then
					if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
						repeat
							...
							topos(v.HumanoidRootPart.CFrame * Pos);
							Attack();
						until not v.Parent or v.Humanoid.Health <= 0 or (not _G.Settings.DragonDojo["Farm Blaze Ember"]) or (not _G.OnBlzeQuest);
					end;
				end;
			end;
		end;
			...
			if _G.Settings.Items["Auto Electric Claw"] then
				if (game:GetService("Players")).LocalPlayer.Backpack:FindFirstChild("Electro") or (game:GetService("Players")).LocalPlayer.Character:FindFirstChild("Electro") then
					if (game:GetService("Players")).LocalPlayer.Backpack:FindFirstChild("Electro") or (game:GetService("Players")).LocalPlayer.Character:FindFirstChild("Electro") and ((game:GetService("Players")).LocalPlayer.Backpack:FindFirstChild("Electro")).Level.Value >= 400 or ((game:GetService("Players")).LocalPlayer.Character:FindFirstChild("Electro")).Level.Value >= 400 then
						if _G.Settings.Main["Farm"] == false then
							repeat
								(game:GetService("RunService")).Heartbeat:wait();
							...
							wait(1);
							(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyElectricClaw");
						elseif _G.Settings.Main["Farm"] == true then
							_G.Settings.Main["Farm"] = false;
							wait(1);
							repeat
								task.wait();
...
if World2 then
	FarmTab:Toggle("Auto Material Radioativo", _G.Settings.Farm["Auto Material Radioativo"], false, function(value)
		_G.Settings.Farm["Auto Material Radioativo"] = value;
		StopTween(_G.Settings.Farm["Auto Material Radioativo"]);
		(getgenv()).SaveSetting();
	end);
	local MaterialsPos1 = CFrame.new(-507.7895202636719, 72.99479675292969, -126.45632934570312);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Material Radioativo"] and World2 then
				pcall(function()
							...
							if v.Name == "Factory Staff" then
								if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									repeat
										...
										topos(v.HumanoidRootPart.CFrame * Pos);
										Attack();
									until not _G.Settings.Farm["Auto Material Radioativo"] or (not v.Parent) or v.Humanoid.Health <= 0;
								end;
							end;
						end;
					else
...
if World2 then
	FarmTab:Toggle("Auto Gota Mística", _G.Settings.Farm["Auto Gota Mística"], false, function(value)
		_G.Settings.Farm["Auto Gota Mística"] = value;
		StopTween(_G.Settings.Farm["Auto Gota Mística"]);
		(getgenv()).SaveSetting();
	end);
	local MaterialsPos2 = CFrame.new(-3352.9013671875, 285.01556396484375, -10534.841796875);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Gota Mística"] and World2 then
				pcall(function()
							...
							if v.Name == "Water Fighter" then
								if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									repeat
										...
										topos(v.HumanoidRootPart.CFrame * Pos);
										Attack();
									until not _G.Settings.Farm["Auto Gota Mística"] or (not v.Parent) or v.Humanoid.Health <= 0;
								end;
							end;
						end;
					else
...
if World1 or World2 then
	FarmTab:Toggle("Auto Minério de Magma", _G.Settings.Farm["Auto Minério de Magma"], "Auto Minério de Magma", function(value)
		_G.Settings.Farm["Auto Minério de Magma"] = value;
		StopTween(_G.Settings.Farm["Auto Minério de Magma"]);
		(getgenv()).SaveSetting();
	end);
	local MaterialsPos3 = CFrame.new(-5850.2802734375, 77.28675079345703, 8848.6748046875);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Minério de Magma"] and World1 then
				pcall(function()
							...
							if v.Name == "Military Spy" then
								if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									repeat
										...
										topos(v.HumanoidRootPart.CFrame * Pos);
										Attack();
									until not _G.Settings.Farm["Auto Minério de Magma"] or (not v.Parent) or v.Humanoid.Health <= 0;
								end;
							end;
						end;
					else
	...
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Minério de Magma"] and World2 then
				pcall(function()
...
if World1 then
	FarmTab:Toggle("Auto Asas Angelicais", _G.Settings.Farm["Auto Asas Angelicais"], false, function(value)
		_G.Settings.Farm["Auto Asas Angelicais"] = value;
		StopTween(_G.Settings.Farm["Auto Asas Angelicais"]);
		(getgenv()).SaveSetting();
	end);
	local MaterialsPos5 = CFrame.new(-7827.15625, 5606.912109375, -1705.5833740234375);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Asas Angelicais"] and World1 then
				pcall(function()
							...
							if v.Name == "Royal Soldier" then
								if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									repeat
										...
										topos(v.HumanoidRootPart.CFrame * Pos);
										Attack();
									until not _G.Settings.Farm["Auto Asas Angelicais"] or (not v.Parent) or v.Humanoid.Health <= 0;
								end;
							end;
						end;
					else
...
if World1 or World2 or World3 then
	FarmTab:Toggle("Auto Couro", _G.Settings.Farm["Auto Couro"], false, function(value)
		_G.Settings.Farm["Auto Couro"] = value;
		StopTween(_G.Settings.Farm["Auto Couro"]);
		(getgenv()).SaveSetting();
	end);
	local MaterialsPos6 = CFrame.new(-1211.8792724609375, 4.787090301513672, 3916.83056640625);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Couro"] and World1 then
				pcall(function()
							...
							if v.Name == "Pirate" then
								if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									repeat
										...
										topos(v.HumanoidRootPart.CFrame * Pos);
										Attack();
									until not _G.Settings.Farm["Auto Couro"] or (not v.Parent) or v.Humanoid.Health <= 0;
								end;
							end;
						end;
					else
	...
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Couro"] and World2 then
				pcall(function()
	...
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Couro"] and World3 then
				pcall(function()
...
if World2 then
	FarmTab:Toggle("Farm Ectoplasm", _G.Settings.Farm["Farm Ectoplasm"], false, function(value)
		_G.Settings.Farm["Farm Ectoplasm"] = value;
		StopTween(_G.Settings.Farm["Farm Ectoplasm"]);
		(getgenv()).SaveSetting();
	end);
	spawn(function()
		pcall(function()
			while wait(0.2) do
				if _G.Settings.Farm["Farm Ectoplasm"] then
					if (game:GetService("Workspace")).Enemies:FindFirstChild("Ship Deckhand") or (game:GetService("Workspace")).Enemies:FindFirstChild("Ship Engineer") or (game:GetService("Workspace")).Enemies:FindFirstChild("Ship Steward") or (game:GetService("Workspace")).Enemies:FindFirstChild("Ship Officer") then
						for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
							if v.Name == "Ship Deckhand" or v.Name == "Ship Engineer" or v.Name == "Ship Steward" or v.Name == "Ship Officer" then
								...
								until _G.Settings.Farm["Farm Ectoplasm"] == false or (not v.Parent) or v.Humanoid.Health <= 0;
							end;
						end;
					else
...
if World1 or World2 or World3 then
	FarmTab:Toggle("Auto Metal Sucata", _G.Settings.Farm["Auto Metal Sucata"], false, function(value)
		_G.Settings.Farm["Auto Metal Sucata"] = value;
		StopTween(_G.Settings.Farm["Auto Metal Sucata"]);
		(getgenv()).SaveSetting();
	end);
	local MaterialsPos9 = CFrame.new(-1132.4202880859375, 14.844913482666016, 4293.30517578125);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Metal Sucata"] and World1 then
				pcall(function()
							...
							if v.Name == "Brute" then
								if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									repeat
										...
										topos(v.HumanoidRootPart.CFrame * Pos);
										Attack();
									until not _G.Settings.Farm["Auto Metal Sucata"] or (not v.Parent) or v.Humanoid.Health <= 0;
								end;
							end;
						end;
					else
	...
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Metal Sucata"] and World2 then
				pcall(function()
	...
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Metal Sucata"] and World3 then
				pcall(function()
...
if World3 then
	FarmTab:Toggle("Auto Cacau Conjurado", _G.Settings.Farm["Auto Cacau Conjurado"], false, function(value)
		_G.Settings.Farm["Auto Cacau Conjurado"] = value;
		StopTween(_G.Settings.Farm["Auto Cacau Conjurado"]);
		(getgenv()).SaveSetting();
	end);
	local MaterialsPos12 = CFrame.new(744.7930908203125, 24.76934242248535, -12637.7255859375);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Cacau Conjurado"] and World3 then
				pcall(function()
							...
							if v.Name == "Chocolate Bar Battler" then
								if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									repeat
										...
										topos(v.HumanoidRootPart.CFrame * Pos);
										Attack();
									until not _G.Settings.Farm["Auto Cacau Conjurado"] or (not v.Parent) or v.Humanoid.Health <= 0;
								end;
							end;
						end;
					else
...
if World3 then
	FarmTab:Toggle("Auto Escama de Dragão", _G.Settings.Farm["Auto Escama de Dragão"], false, function(value)
		_G.Settings.Farm["Auto Escama de Dragão"] = value;
		StopTween(_G.Settings.Farm["Auto Escama de Dragão"]);
		(getgenv()).SaveSetting();
	end);
	local MaterialsPos13 = CFrame.new(5824.06982421875, 51.38640213012695, -1106.694580078125);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Escama de Dragão"] and World3 then
				pcall(function()
							...
							if v.Name == "Dragon Crew Warrior" then
								if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									repeat
										...
										topos(v.HumanoidRootPart.CFrame * Pos);
										Attack();
									until not _G.Settings.Farm["Auto Escama de Dragão"] or (not v.Parent) or v.Humanoid.Health <= 0;
								end;
							end;
						end;
					else
...
if World3 then
	FarmTab:Toggle("Auto Pó de Arma", _G.Settings.Farm["Auto Pó de Arma"], false, function(value)
		_G.Settings.Farm["Auto Pó de Arma"] = value;
		StopTween(_G.Settings.Farm["Auto Pó de Arma"]);
		(getgenv()).SaveSetting();
	end);
	local MaterialsPos14 = CFrame.new(-379.6134338378906, 73.84449768066406, 5928.5263671875);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Pó de Arma"] and World3 then
				pcall(function()
							...
							if v.Name == "Pistol Billionaire" then
								if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									repeat
										...
										topos(v.HumanoidRootPart.CFrame * Pos);
										Attack();
									until not _G.Settings.Farm["Auto Pó de Arma"] or (not v.Parent) or v.Humanoid.Health <= 0;
								end;
							end;
						end;
					else
...
if World3 then
	FarmTab:Toggle("Auto Cauda de Peixe", _G.Settings.Farm["Auto Cauda de Peixe"], false, function(value)
		_G.Settings.Farm["Auto Cauda de Peixe"] = value;
		StopTween(_G.Settings.Farm["Auto Cauda de Peixe"]);
		(getgenv()).SaveSetting();
	end);
	local MaterialsPos15 = CFrame.new(-10961.0126953125, 331.7977600097656, -8914.29296875);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Cauda de Peixe"] and World3 then
				pcall(function()
...
if World3 then
	FarmTab:Toggle("Auto Mini Presa", _G.Settings.Farm["Auto Mini Presa"], false, function(value)
		_G.Settings.Farm["Auto Mini Presa"] = value;
		StopTween(_G.Settings.Farm["Auto Mini Presa"]);
		(getgenv()).SaveSetting();
	end);
	local MaterialsPos16 = CFrame.new(-13516.0458984375, 469.8182373046875, -6899.16064453125);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Farm["Auto Mini Presa"] and World3 then
				pcall(function()
							...
							if v.Name == "Mythological Pirate" then
								if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									repeat
										...
										topos(v.HumanoidRootPart.CFrame * Pos);
										Attack();
									until not _G.Settings.Farm["Auto Mini Presa"] or (not v.Parent) or v.Humanoid.Health <= 0;
								end;
							end;
						end;
					else
...
if World3 then
		...
		if not CheckItemCount("Dark Fragment", 1) then
			if World2 then
				...
				elseif game.Players.LocalPlayer.Character:FindFirstChild("Fist of Darkness") or game.Players.LocalPlayer.Backpack:FindFirstChild("Fist of Darkness") then
					...
					until not v or (not v.Parent) or (not _G.Settings.Items["Auto Guitarra da Alma"]);
				end;
			else
				(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("TravelDressrosa");
			end;
			...
			if game.PlaceId == PlaceId then
				if not DetectMob(Mob) then
					TeleportSpawnMob(Mob, _G.Settings.Items["Auto Guitarra da Alma"]);
				else
					...
					repeat
						...
						topos(v.HumanoidRootPart.CFrame * Pos);
						Attack();
					until not v or (not v.Parent) or v.Humanoid.Health == 0 or (not _G.Settings.Items["Auto Guitarra da Alma"]);
				end;
			else
	...
	ItemsTab:Toggle("Auto Guitarra da Alma", _G.Settings.Items["Auto Guitarra da Alma"], false, function(value)
		_G.Settings.Items["Auto Guitarra da Alma"] = value;
		StopTween(_G.Settings.Items["Auto Guitarra da Alma"]);
		(getgenv()).SaveSetting();
	end);
	spawn(function()
		while wait(0.2) do
			pcall(function()
				if _G.Settings.Items["Auto Guitarra da Alma"] then
					AutoSoulGuitar();
				end;
			end);
		end;
...
if World3 then
	ItemsTab:Toggle("Auto Foice Assombrada", _G.Settings.Items["Auto Foice Assombrada"], "Auto Kill Soul Reaper", function(value)
		_G.Settings.Items["Auto Foice Assombrada"] = value;
		StopTween(_G.Settings.Items["Auto Foice Assombrada"]);
		(getgenv()).SaveSetting();
	end);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Items["Auto Foice Assombrada"] then
				pcall(function()
						...
						for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
							if string.find(v.Name, "Soul Reaper") then
								repeat
									...
									Attack();
									v.HumanoidRootPart.Transparency = 1;
								until v.Humanoid.Health <= 0 or _G.Settings.Items["Auto Foice Assombrada"] == false;
							end;
						end;
...
if World1 then
	ItemsTab:Toggle("Auto Espada do Warden", _G.Settings.Items["Auto Espada do Warden"], "Auto Get Warden Sword", function(value)
		_G.Settings.Items["Auto Espada do Warden"] = value;
		StopTween(_G.Settings.Items["Auto Espada do Warden"]);
		(getgenv()).SaveSetting();
	end);
	local NamfonPos = CFrame.new(5186.14697265625, 24.86684226989746, 832.1885375976562);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Items["Auto Espada do Warden"] and World1 then
				pcall(function()
							...
							if v.Name == "Chief Warden" then
								if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									repeat
										...
										topos(v.HumanoidRootPart.CFrame * Pos);
										Attack();
									until not _G.Settings.Items["Auto Espada do Warden"] or (not v.Parent) or v.Humanoid.Health <= 0;
								end;
							end;
						end;
					else
...
if World3 then
	ItemsTab:Toggle("Auto Katana Dupla Amaldiçoada", _G.Settings.Items["Auto Katana Dupla Amaldiçoada"], "Must be have Yama and Tushita", function(value)
		_G.Settings.Items["Auto Katana Dupla Amaldiçoada"] = value;
		StopTween(_G.Settings.Items["Auto Katana Dupla Amaldiçoada"]);
		(getgenv()).SaveSetting();
	end);
	...
	spawn(function()
		while wait(0.2) do
			pcall(function()
				if _G.Settings.Items["Auto Katana Dupla Amaldiçoada"] then
					...
					if (game:GetService("Workspace")).Enemies:FindFirstChild("Mythological Pirate") then
						for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
							if v.Name == "Mythological Pirate" then
								...
								until _G.Settings.Items["Auto Katana Dupla Amaldiçoada"] == false or Auto_Quest_Yama_1 == false;
								(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("CDKQuest", "StartTrial", "Evil");
							end;
						end;
					else
				...
				pcall(function()
					for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
						if v:FindFirstChild("HazeESP") then
							...
							until _G.Settings.Items["Auto Katana Dupla Amaldiçoada"] == false or Auto_Quest_Yama_2 == false or (not v.Parent) or v.Humanoid.Health <= 0 or (not v:FindFirstChild("HazeESP"));
						else
			...
			if Auto_Quest_Yama_3 then
				pcall(function()
					...
					elseif (game:GetService("Workspace")).Map:FindFirstChild("HellDimension") then
						...
						until _G.Settings.Items["Auto Katana Dupla Amaldiçoada"] == false or Auto_Quest_Yama_3 == false or GetMaterial("Alucard Fragment") == 3;
								...
								if v.Name == "Soul Reaper" then
									if v.Humanoid.Health > 0 then
										repeat
											wait();
											topos(v.HumanoidRootPart.CFrame * Pos);
										until _G.Settings.Items["Auto Katana Dupla Amaldiçoada"] == false or Auto_Quest_Yama_3 == false or (game:GetService("Workspace")).Map:FindFirstChild("HellDimension");
									end;
								end;
							end;
						else
			...
			if Auto_Quest_Tushita_3 then
				pcall(function()
								...
								if v.Name == "Cake Queen" then
									if v.Humanoid.Health > 0 then
										repeat
											...
											MonFarm = v.Name;
											Attack();
										until _G.Settings.Items["Auto Katana Dupla Amaldiçoada"] == false or Auto_Quest_Tushita_3 == false or (game:GetService("Workspace")).Map:FindFirstChild("HeavenlyDimension");
									end;
								end;
							end;
						else
					...
					elseif (game:GetService("Workspace")).Map:FindFirstChild("HeavenlyDimension") then
						...
						until not _G.Settings.Items["Auto Katana Dupla Amaldiçoada"] or (not Auto_Quest_Tushita_3) or GetMaterial("Alucard Fragment") == 6;
					end;
				end);
			end;
		end;
...
if World3 then
						...
						for i, v in pairs((game:GetService("Workspace")).Boats:GetChildren()) do
							if v.Name == _G.Settings.SeaEvent["Selected Boat"] then
								if v:FindFirstChild("MyBoatEsp") then
									if (game.Players.LocalPlayer.Character:WaitForChild("Humanoid")).Sit == false then
										if CheckShark() and _G.Settings.SeaEvent["Farm Shark"] or (game:GetService("Workspace")).Enemies:FindFirstChild("Terrorshark") and _G.Settings.SeaEvent["Farm Terrorshark"] or CheckPiranha() and _G.Settings.SeaEvent["Farm Piranha"] or (game:GetService("Workspace")).Enemies:FindFirstChild("Fish Crew Member") and _G.Settings.SeaEvent["Farm Fish Crew Member"] or (game:GetService("Workspace")).Enemies:FindFirstChild("FishBoat") and _G.Settings.SeaEvent["Farm Ghost Ship"] or (game:GetService("Workspace")).Enemies:FindFirstChild("PirateBrigade") and _G.Settings.SeaEvent["Farm Pirate Brigade"] or (game:GetService("Workspace")).Enemies:FindFirstChild("PirateGrandBrigade") and _G.Settings.SeaEvent["Farm Pirate Grand Brigade"] or CheckSeaBeast() and _G.Settings.SeaEvent["Farm Seabeasts"] then
											if stoppos then
												stoppos:Stop();
											end;
										else
										...
										until CheckShark() and _G.Settings.SeaEvent["Farm Shark"] or (game:GetService("Workspace")).Enemies:FindFirstChild("Terrorshark") and _G.Settings.SeaEvent["Farm Terrorshark"] or CheckPiranha() and _G.Settings.SeaEvent["Farm Piranha"] or (game:GetService("Workspace")).Enemies:FindFirstChild("Fish Crew Member") and _G.Settings.SeaEvent["Farm Fish Crew Member"] or (game:GetService("Workspace")).Enemies:FindFirstChild("FishBoat") and _G.Settings.SeaEvent["Farm Ghost Ship"] or (game:GetService("Workspace")).Enemies:FindFirstChild("PirateBrigade") and _G.Settings.SeaEvent["Farm Pirate Brigade"] or (game:GetService("Workspace")).Enemies:FindFirstChild("PirateGrandBrigade") and _G.Settings.SeaEvent["Farm Pirate Grand Brigade"] or CheckSeaBeast() and _G.Settings.SeaEvent["Farm Seabeasts"] or (game.Players.LocalPlayer.Character:WaitForChild("Humanoid")).Sit == false or _G.Settings.SeaEvent["Sail Boat"] == false;
										if StopTweenBoat then
											StopTweenBoat:Stop();
										end;
	...
	spawn(function()
		while wait(0.2) do
			if _G.Settings.SeaEvent["Sail Boat"] then
				pcall(function()
					if _G.Settings.SeaEvent["Sail Boat"] and (game:GetService("Workspace")).Enemies:FindFirstChild("Fish Crew Member") and _G.Settings.SeaEvent["Farm Fish Crew Member"] then
						for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
								...
								if v.Name == "Fish Crew Member" then
									if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
										repeat
											...
											Attack();
											_G.SeaSkill = false;
										until not _G.Settings.SeaEvent["Farm Fish Crew Member"] or (not v.Parent) or v.Humanoid.Health <= 0;
									end;
								end;
							end;
						end;
					elseif _G.Settings.SeaEvent["Sail Boat"] and (game:GetService("Workspace")).Enemies:FindFirstChild("FishBoat") and _G.Settings.SeaEvent["Farm Ghost Ship"] then
						for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
							if (game:GetService("Workspace")).Enemies:FindFirstChild("FishBoat") then
								...
								until not v.Parent or v.Health < 0 or (not (game:GetService("Workspace")).Enemies:FindFirstChild("FishBoat")) or (not v:FindFirstChild("Engine")) or (not _G.Settings.SeaEvent["Farm Ghost Ship"]);
								Skillaimbot = false;
								_G.SeaSkill = false;
							end;
						end;
					elseif _G.Settings.SeaEvent["Sail Boat"] and (game:GetService("Workspace")).Enemies:FindFirstChild("PirateGrandBrigade") and _G.Settings.SeaEvent["Farm Pirate Grand Brigade"] then
						for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
							if (game:GetService("Workspace")).Enemies:FindFirstChild("PirateGrandBrigade") then
								repeat
									...
									AimSkill = v.Engine.CFrame * CFrame.new(0, (-15), 0);
									AimBotSkillPosition = AimSkill.Position;
								until not v.Parent or v.Health.Value < 0 or (not (game:GetService("Workspace")).Enemies:FindFirstChild("PirateGrandBrigade")) or (not v:FindFirstChild("Engine")) or (not _G.Settings.SeaEvent["Farm Pirate Grand Brigade"]);
								Skillaimbot = false;
								_G.SeaSkill = false;
							end;
						end;
					elseif _G.Settings.SeaEvent["Sail Boat"] and (game:GetService("Workspace")).Enemies:FindFirstChild("PirateBrigade") and _G.Settings.SeaEvent["Farm Pirate Brigade"] then
						for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
							if (game:GetService("Workspace")).Enemies:FindFirstChild("PirateBrigade") then
								repeat
									...
									AimSkill = v.Engine.CFrame * CFrame.new(0, (-15), 0);
									AimBotSkillPosition = AimSkill.Position;
								until not v.Parent or v.Health.Value < 0 or (not (game:GetService("Workspace")).Enemies:FindFirstChild("PirateBrigade")) or (not v:FindFirstChild("Engine")) or (not _G.Settings.SeaEvent["Farm Pirate Brigade"]);
								Skillaimbot = false;
								_G.SeaSkill = false;
							end;
						end;
					elseif _G.Settings.SeaEvent["Sail Boat"] and CheckSeaBeast() and _G.Settings.SeaEvent["Farm Seabeasts"] then
						if (game:GetService("Workspace")):FindFirstChild("SeaBeasts") then
							for i, v in pairs((game:GetService("Workspace")).SeaBeasts:GetChildren()) do
								if CheckSeaBeast() then
									repeat
					...
					elseif _G.Settings.SeaEvent["Sail Boat"] and (game:GetService("Workspace")).Enemies:FindFirstChild("Terrorshark") and _G.Settings.SeaEvent["Farm Terrorshark"] then
						for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
							if (game:GetService("Workspace")).Enemies:FindFirstChild("Terrorshark") then
								if v.Name == "Terrorshark" then
									if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
										...
										until not _G.Settings.SeaEvent["Farm Terrorshark"] or (not v.Parent) or v.Humanoid.Health <= 0;
									end;
								end;
							end;
						end;
					elseif _G.Settings.SeaEvent["Sail Boat"] and CheckPiranha() and _G.Settings.SeaEvent["Farm Piranha"] then
						for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
							if (game:GetService("Workspace")).Enemies:FindFirstChild("Piranha") then
								if v.Name == "Piranha" then
									if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
										repeat
											...
											Attack();
											_G.SeaSkill = false;
										until not _G.Settings.SeaEvent["Farm Piranha"] or (not v.Parent) or v.Humanoid.Health <= 0;
									end;
								end;
							end;
						end;
					elseif _G.Settings.SeaEvent["Sail Boat"] and CheckShark() and _G.Settings.SeaEvent["Farm Shark"] then
						for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
							if (game:GetService("Workspace")).Enemies:FindFirstChild("Shark") then
								if v.Name == "Shark" then
									if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
										repeat
											...
											Attack();
											_G.SeaSkill = false;
										until not _G.Settings.SeaEvent["Farm Shark"] or (not v.Parent) or v.Humanoid.Health <= 0;
									end;
								end;
							end;
						end;
	...
	SeaTab:Toggle("Farm Shark", _G.Settings.SeaEvent["Farm Shark"], "Auto Kill Shark", function(value)
		_G.Settings.SeaEvent["Farm Shark"] = value;
		StopTween(_G.Settings.SeaEvent["Farm Shark"]);
		(getgenv()).SaveSetting();
	end);
	SeaTab:Toggle("Farm Piranha", _G.Settings.SeaEvent["Farm Piranha"], "Auto Kill Piranha", function(value)
		_G.Settings.SeaEvent["Farm Piranha"] = value;
		StopTween(_G.Settings.SeaEvent["Farm Piranha"]);
		(getgenv()).SaveSetting();
	end);
	SeaTab:Toggle("Farm Fish Crew Member", _G.Settings.SeaEvent["Farm Fish Crew Member"], "Auto Kill Fish Crew Member", function(value)
		_G.Settings.SeaEvent["Farm Fish Crew Member"] = value;
		StopTween(_G.Settings.SeaEvent["Farm Fish Crew Member"]);
		(getgenv()).SaveSetting();
	end);
	SeaTab:Label("Boat");
	SeaTab:Toggle("Auto Kill Ghost Ship", _G.Settings.SeaEvent["Farm Ghost Ship"], "Auto Kill Use Skill", function(value)
		_G.Settings.SeaEvent["Farm Ghost Ship"] = value;
		if not _G.Settings.SeaEvent["Farm Ghost Ship"] then
			_G.SeaSkill = false;
			Skillaimbot = false;
		end;
		StopTween(_G.Settings.SeaEvent["Farm Ghost Ship"]);
		(getgenv()).SaveSetting();
	end);
	SeaTab:Toggle("Auto Kill Pirate Brigade", _G.Settings.SeaEvent["Farm Pirate Brigade"], "Auto Kill Enemies Use Skill", function(value)
		_G.Settings.SeaEvent["Farm Pirate Brigade"] = value;
		StopTween(_G.Settings.SeaEvent["Farm Pirate Brigade"]);
		(getgenv()).SaveSetting();
	end);
	SeaTab:Toggle("Auto Kill Pirate Grand Brigade", _G.Settings.SeaEvent["Farm Pirate Grand Brigade"], "Auto Kill Enemies Use Skill", function(value)
		_G.Settings.SeaEvent["Farm Pirate Grand Brigade"] = value;
		StopTween(_G.Settings.SeaEvent["Farm Pirate Grand Brigade"]);
		(getgenv()).SaveSetting();
	end);
	SeaTab:Label("Boss");
	SeaTab:Toggle("Auto Kill Terrorshark", _G.Settings.SeaEvent["Farm Terrorshark"], false, function(value)
		_G.Settings.SeaEvent["Farm Terrorshark"] = value;
		StopTween(_G.Settings.SeaEvent["Farm Terrorshark"]);
		(getgenv()).SaveSetting();
	end);
	SeaTab:Toggle("Auto Kill Seabest", _G.Settings.SeaEvent["Farm Seabeasts"], false, function(value)
		_G.Settings.SeaEvent["Farm Seabeasts"] = value;
		if not _G.Settings.SeaEvent["Farm Seabeasts"] then
			_G.SeaSkill = false;
			Skillaimbot = false;
		end;
		StopTween(_G.Settings.SeaEvent["Farm Seabeasts"]);
		(getgenv()).SaveSetting();
	end);
...
if World2 then
	ItemsTab:Toggle("Auto Tridente Dragão", _G.Settings.Items["Auto Tridente Dragão"], false, function(value)
		_G.Settings.Items["Auto Tridente Dragão"] = value;
		StopTween(_G.Settings.Items["Auto Tridente Dragão"]);
		(getgenv()).SaveSetting();
	end);
	local TridentPos = CFrame.new(-3914.830322265625, 123.29389190673828, -11516.8642578125);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Items["Auto Tridente Dragão"] and World2 then
				pcall(function()
							...
							if v.Name == "Tide Keeper" then
								if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									repeat
										...
										topos(v.HumanoidRootPart.CFrame * Pos);
										Attack();
									until not _G.Settings.Items["Auto Tridente Dragão"] or (not v.Parent) or v.Humanoid.Health <= 0;
								end;
							end;
						end;
					else
...
if World2 then
	ItemsTab:Toggle("Auto Bartlio Quest", _G.Settings.Items["Auto Missão do Bartilo"], false, function(value)
		_G.Settings.Items["Auto Missão do Bartilo"] = value;
		(getgenv()).SaveSetting();
	end);
	spawn(function()
		pcall(function()
			while wait(0.2) do
				if _G.Settings.Items["Auto Missão do Bartilo"] then
						...
						if string.find((game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Swan Pirates") and string.find((game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "50") and (game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Visible == true then
							if (game:GetService("Workspace")).Enemies:FindFirstChild("Swan Pirate") then
									...
									if v.Name == Ms then
										pcall(function()
											repeat
												...
												MonFarm = v.Name;
												Attack();
											until not v.Parent or v.Humanoid.Health <= 0 or _G.Settings.Items["Auto Missão do Bartilo"] == false or (game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Visible == false;
										end);
									end;
								end;
							else
								repeat
									...
									wait();
								until not _G.Settings.Items["Auto Missão do Bartilo"] or ((game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new(932.624451, 156.106079, 1180.27466, (-0.973085582), 0.0000000455137119, (-0.230443969), 0.0000000267024713, 1, 0.0000000847491108, 0.230443969, 0.0000000763147128, (-0.973085582))).Magnitude <= 10;
							end;
						else
							repeat
								topos(CFrame.new(-456.28952, 73.0200958, 299.895966));
								wait();
							until not _G.Settings.Items["Auto Missão do Bartilo"] or ((game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new((-456.28952), 73.0200958, 299.895966)).Magnitude <= 10;
							wait(1.1);
					...
					elseif (game:GetService("Players")).LocalPlayer.Data.Level.Value >= 800 and (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo") == 1 then
							...
							for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
								if v.Name == Ms then
									...
									repeat
										...
										topos(v.HumanoidRootPart.CFrame * Pos);
										Attack();
									until not v.Parent or v.Humanoid.Health <= 0 or _G.Settings.Items["Auto Missão do Bartilo"] == false;
								end;
							end;
						elseif (game:GetService("ReplicatedStorage")):FindFirstChild("Jeremy [Lv. 850] [Boss]") then
							...
							repeat
								...
								wait();
							until not _G.Settings.Items["Auto Missão do Bartilo"] or ((game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new(2099.88159, 448.931, 648.997375)).Magnitude <= 10;
							wait(2);
						else
							repeat
								topos(CFrame.new(2099.88159, 448.931, 648.997375));
					...
					elseif (game:GetService("Players")).LocalPlayer.Data.Level.Value >= 800 and (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo") == 2 then
						repeat
							...
							wait();
						until not _G.Settings.Items["Auto Missão do Bartilo"] or ((game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new((-1850.49329), 13.1789551, 1750.89685)).Magnitude <= 10;
						wait(1);
						repeat
							topos(CFrame.new(-1858.87305, 19.3777466, 1712.01807));
							wait();
						until not _G.Settings.Items["Auto Missão do Bartilo"] or ((game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new((-1858.87305), 19.3777466, 1712.01807)).Magnitude <= 10;
						wait(1);
						repeat
							topos(CFrame.new(-1803.94324, 16.5789185, 1750.89685));
							wait();
						until not _G.Settings.Items["Auto Missão do Bartilo"] or ((game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new((-1803.94324), 16.5789185, 1750.89685)).Magnitude <= 10;
						wait(1);
						repeat
							topos(CFrame.new(-1858.55835, 16.8604317, 1724.79541));
							wait();
						until not _G.Settings.Items["Auto Missão do Bartilo"] or ((game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new((-1858.55835), 16.8604317, 1724.79541)).Magnitude <= 10;
						wait(1);
						repeat
							topos(CFrame.new(-1869.54224, 15.987854, 1681.00659));
							wait();
						until not _G.Settings.Items["Auto Missão do Bartilo"] or ((game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new((-1869.54224), 15.987854, 1681.00659)).Magnitude <= 10;
						wait(1);
						repeat
							topos(CFrame.new(-1800.0979, 16.4978027, 1684.52368));
							wait();
						until not _G.Settings.Items["Auto Missão do Bartilo"] or ((game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new((-1800.0979), 16.4978027, 1684.52368)).Magnitude <= 10;
						wait(1);
						repeat
							topos(CFrame.new(-1819.26343, 14.795166, 1717.90625));
							wait();
						until not _G.Settings.Items["Auto Missão do Bartilo"] or ((game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new((-1819.26343), 14.795166, 1717.90625)).Magnitude <= 10;
						wait(1);
						repeat
							topos(CFrame.new(-1813.51843, 14.8604736, 1724.79541));
							wait();
						until not _G.Settings.Items["Auto Missão do Bartilo"] or ((game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new((-1813.51843), 14.8604736, 1724.79541)).Magnitude <= 10;
					end;
				end;
			end;
		end);
...
CombatTab:Toggle("Farm Player", false, "Auto Kill Players", function(value)
...
TeleportTab:Toggle("Teleport", false, "Tween To Island", function(value)
	...
	if _G.TeleportIsland == true then
		repeat
			...
			elseif _G.SelectIsland == "Dojo Dragão" then
...
if World2 then
	...
	ShopTab:Toggle("Auto Comprar Espada Lendária", _G.Settings.Shop["Auto Comprar Espada Lendária"], "Buy Legendary Sword When Spawn", function(value)
		_G.Settings.Shop["Auto Comprar Espada Lendária"] = value;
		(getgenv()).SaveSetting();
	end);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Shop["Auto Comprar Espada Lendária"] then
				pcall(function()
...
if World2 or World3 then
	...
	ShopTab:Toggle("Auto Comprar Cor do Haki", _G.Settings.Shop["Auto Comprar Cor do Haki"], "Auto Comprar Cor do Haki", function(value)
		_G.Settings.Shop["Auto Comprar Cor do Haki"] = value;
		(getgenv()).SaveSetting();
	end);
	spawn(function()
		while wait(0.2) do
			if _G.Settings.Shop["Auto Comprar Cor do Haki"] then
...
LocalPlayerTab:Seperator("Jogador");
...
spawn(function()
	pcall(function()
		while wait(0.2) do
			if World2 or World3 then
				if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
					MirageStatus:Set("Miragem Spawning");
				else
					MirageStatus:Set("Miragem Not Spawn");
				end;
			end;
		end;
	end);
...
ServTab:Seperator("Miragem Fruit Stock");
